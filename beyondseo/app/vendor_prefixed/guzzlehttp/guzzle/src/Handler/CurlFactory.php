...
namespace BeyondSEODeps\GuzzleHttp\Handler;

use BeyondSEODeps\GuzzleHttp\Exception\ConnectException;
use BeyondSEODeps\GuzzleHttp\Exception\RequestException;
use BeyondSEODeps\GuzzleHttp\Promise as P;
use BeyondSEODeps\GuzzleHttp\Promise\FulfilledPromise;
use BeyondSEODeps\GuzzleHttp\Promise\PromiseInterface;
use BeyondSEODeps\GuzzleHttp\Psr7\LazyOpenStream;
use BeyondSEODeps\GuzzleHttp\TransferStats;
use BeyondSEODeps\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private static function createRejection(EasyHandle $easy, array $ctx): PromiseInterface
    {
        ...
        if ('' !== $sanitizedError) {
            $redactedUriString = \BeyondSEODeps\GuzzleHttp\Psr7\Utils::redactUserInfo($uri)->__toString();
    ...
    private static function sanitizeCurlError(string $error, UriInterface $uri): string
    {
        ...
        $redactedUriString = \BeyondSEODeps\GuzzleHttp\Psr7\Utils::redactUserInfo($baseUri)->__toString();
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \BeyondSEODeps\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \BeyondSEODeps\GuzzleHttp\Psr7\Utils::streamFor($sink);
