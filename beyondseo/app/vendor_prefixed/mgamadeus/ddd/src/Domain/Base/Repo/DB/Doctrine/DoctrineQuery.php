...
use BeyondSEODeps\Doctrine\Common\Cache\Cache;
...
use BeyondSEODeps\Doctrine\ORM\AbstractQuery;
use BeyondSEODeps\Doctrine\ORM\Internal\Hydration\IterableResult;
use BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata;
use BeyondSEODeps\Doctrine\ORM\Query;
use BeyondSEODeps\Doctrine\ORM\Query\AST\DeleteStatement;
use BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement;
use BeyondSEODeps\Doctrine\ORM\Query\AST\UpdateStatement;
use BeyondSEODeps\Doctrine\ORM\Query\Exec\AbstractSqlExecutor;
use BeyondSEODeps\Doctrine\ORM\Query\Parameter;
use BeyondSEODeps\Doctrine\ORM\Query\ParameterTypeInferer;
...
use BeyondSEODeps\Doctrine\ORM\TransactionRequiredException;
...
class DoctrineQuery extends Query
{
    ...
    /**
     * A string with a class name that implements \BeyondSEODeps\Doctrine\ORM\Query\TreeWalker
     ...
     *
     * @see \BeyondSEODeps\Doctrine\DBAL\LockMode
     *
     * @param int $lockMode
