...
use BeyondSEODeps\Doctrine\Common\Lexer\Token;
...
use BeyondSEODeps\Doctrine\ORM\Query\AST\Functions;
use BeyondSEODeps\Doctrine\ORM\Query\Lexer;
use BeyondSEODeps\Doctrine\ORM\Query\Parser;
use BeyondSEODeps\Doctrine\ORM\Query\ParserResult;
...
use BeyondSEODeps\Doctrine\ORM\Query\TreeWalkerChain;
use LogicException;
use ReflectionClass;
...
class DoctrineParser extends Parser
{
     ...
     */
    protected static $stringFunctions = ['concat' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\ConcatFunction::class, 'substring' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\SubstringFunction::class, 'trim' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\TrimFunction::class, 'lower' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\LowerFunction::class, 'upper' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\UpperFunction::class, 'identity' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\IdentityFunction::class];
    /**
     * @readonly Maps BUILT-IN numeric function names to AST class names.
     * @psalm-var array<string, class-string<Functions\FunctionNode>>
     */
    protected static $numericFunctions = [
        'length' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\LengthFunction::class,
        'locate' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\LocateFunction::class,
        'abs' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\AbsFunction::class,
        'sqrt' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\SqrtFunction::class,
        'mod' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\ModFunction::class,
        'size' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\SizeFunction::class,
        'date_diff' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\DateDiffFunction::class,
        'bit_and' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\BitAndFunction::class,
        'bit_or' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\BitOrFunction::class,
        // Aggregate functions
        'min' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\MinFunction::class,
        'max' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\MaxFunction::class,
        'avg' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\AvgFunction::class,
        'sum' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\SumFunction::class,
        'count' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\CountFunction::class,
    ];
    /**
     * @readonly Maps BUILT-IN datetime function names to AST class names.
     * @psalm-var array<string, class-string<Functions\FunctionNode>>
     */
    protected static $datetimeFunctions = ['current_date' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\CurrentDateFunction::class, 'current_time' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\CurrentTimeFunction::class, 'current_timestamp' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\CurrentTimestampFunction::class, 'date_add' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\DateAddFunction::class, 'date_sub' => \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\DateSubFunction::class];
    /*
        ...
        if ($this->customTreeWalkers) {
            ...
            switch (true) {
                ...
                case $AST instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\DeleteStatement:
                    ...
                    break;
                case $AST instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement:
                default:
     ...
     */
    protected function fixIdentificationVariableOrder(\BeyondSEODeps\Doctrine\ORM\Query\AST\Node $AST): void
    {
        if (count($this->identVariableExpressions) <= 1) {
            return;
        }
        assert($AST instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement);
    ...
    {
        return in_array($tokenType, [TokenType::T_AVG, TokenType::T_MIN, TokenType::T_MAX, TokenType::T_SUM, TokenType::T_COUNT], true);
    }
    /**
    ...
    {
        assert($this->lexer->lookahead !== null);
        return in_array($this->lexer->lookahead->type, [TokenType::T_ALL, TokenType::T_ANY, TokenType::T_SOME], true);
    }
    /**
     ...
     */
    protected function processDeferredNewObjectExpressions(\BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement $AST): void
    {
    ...
    protected function processDeferredPathExpressions(): void
    {
        foreach ($this->deferredPathExpressions as $deferredItem) {
            ...
            $fieldType = \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD;
            if (isset($class->associationMappings[$field])) {
                $assoc = $class->associationMappings[$field];
                $fieldType = $assoc['type'] & ClassMetadata::TO_ONE ? \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION : \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_COLLECTION_VALUED_ASSOCIATION;
            }
            ...
            if (!($expectedType & $fieldType)) {
                ...
                if ($expectedType & \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD) {
                    $expectedStringTypes[] = 'StateFieldPathExpression';
                }
                // Validate single valued association (*-to-one)
                if ($expectedType & \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION) {
                    $expectedStringTypes[] = 'SingleValuedAssociationField';
                }
                // Validate single valued association (*-to-many)
                if ($expectedType & \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_COLLECTION_VALUED_ASSOCIATION) {
    ...
    {
        return $this->PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION | \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_COLLECTION_VALUED_ASSOCIATION);
    }
    /**
     * SingleValuedPathExpression ::= StateFieldPathExpression | SingleValuedAssociationPathExpression
     *
    ...
    {
        return $this->PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD | \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION);
    }
    /**
     * StateFieldPathExpression ::= IdentificationVariable "." StateField
     *
    ...
    {
        return $this->PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD);
    }
    /**
     * SingleValuedAssociationPathExpression ::= IdentificationVariable "." SingleValuedAssociationField
     *
    ...
    {
        return $this->PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION);
    }
    /**
     * CollectionValuedPathExpression ::= IdentificationVariable "." CollectionValuedAssociationField
     *
    ...
    {
        return $this->PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_COLLECTION_VALUED_ASSOCIATION);
    }
    /**
    ...
    {
        // Check Join type
        $joinType = \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_INNER;
        switch (true) {
            case $this->lexer->isNextToken(TokenType::T_LEFT):
                $this->match(TokenType::T_LEFT);
                $joinType = \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFT;
                // Possible LEFT OUTER join
                if ($this->lexer->isNextToken(TokenType::T_OUTER)) {
                    $this->match(TokenType::T_OUTER);
                    $joinType = \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFTOUTER;
                }
                break;
        ...
        if ($joinDeclaration instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\RangeVariableDeclaration) {
    ...
    public function ScalarExpression()
    {
        ...
        switch (true) {
            ...
            case $lookahead === TokenType::T_FALSE:
                ...
                return new AST\Literal(\BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::BOOLEAN, $this->lexer->token->value);
    ...
    public function SelectExpression()
    {
        ...
        if ($mustHaveAliasResultVariable || $this->lexer->isNextToken(TokenType::T_IDENTIFIER)) {
            assert($expression instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node || is_string($expression));
            $token = $this->lexer->lookahead;
    ...
    public function ConditionalPrimary()
    {
        ...
        if ($peek !== null && (in_array($peek->value, ['=', '<', '<=', '<>', '>', '>=', '!='], true) || in_array($peek->type, [TokenType::T_NOT, TokenType::T_BETWEEN, TokenType::T_LIKE, TokenType::T_IN, TokenType::T_IS, TokenType::T_EXISTS], true) || $this->isMathOperator($peek))) {
            $condPrimary->simpleConditionalExpression = $this->SimpleConditionalExpression();
            return $condPrimary;
        }
        $this->match(TokenType::T_OPEN_PARENTHESIS);
    ...
    public function Literal()
    {
        ...
        switch ($this->lexer->lookahead->type) {
            case TokenType::T_STRING:
                ...
                return new AST\Literal(\BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::STRING, $this->lexer->token->value);
            case TokenType::T_INTEGER:
            case TokenType::T_FLOAT:
                $this->match($this->lexer->isNextToken(TokenType::T_INTEGER) ? TokenType::T_INTEGER : TokenType::T_FLOAT);
                return new AST\Literal(\BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::NUMERIC, $this->lexer->token->value);
    ...
    public function LikeExpression()
    {
        ...
        if ($this->lexer->lookahead !== null && $this->lexer->lookahead->type === TokenType::T_ESCAPE) {
            ...
            $this->match(TokenType::T_STRING);
            assert($this->lexer->token !== null);
            $escapeChar = new AST\Literal(\BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::STRING, $this->lexer->token->value);
        }
     ...
     */
    protected function CustomFunctionDeclaration(): ?\BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\FunctionNode
    {
        assert($this->lexer->lookahead !== null);
        $token = $this->lexer->lookahead;
        $funcName = strtolower($token->value);
