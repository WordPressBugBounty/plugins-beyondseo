...
namespace BeyondSEODeps\DDD\Infrastructure\Cache\Predis\Connection\Replication;
...
class SentinelReplication implements ReplicationInterface
{
    ...
    public function __construct(
        $service,
        array $sentinels,
        ConnectionFactoryInterface $connectionFactory, ?ReplicationStrategy $strategy = null
    ) {
