...
namespace BeyondSEODeps\Doctrine\Common\Annotations;

use BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Attribute;
use BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Attributes;
use BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Enum;
use BeyondSEODeps\Doctrine\Common\Annotations\Annotation\NamedArgumentConstructor;
use BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Target;
use ReflectionClass;
...
final class DocParser
{
     ...
     */
    private static $annotationMetadata = [\BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Target::class => ['is_annotation' => true, 'has_constructor' => true, 'has_named_argument_constructor' => false, 'properties' => [], 'targets_literal' => 'ANNOTATION_CLASS', 'targets' => Target::TARGET_CLASS, 'default_property' => 'value', 'attribute_types' => ['value' => ['required' => false, 'type' => 'array', 'array_type' => 'string', 'value' => 'array<string>']]], \BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Attribute::class => ['is_annotation' => true, 'has_constructor' => false, 'has_named_argument_constructor' => false, 'targets_literal' => 'ANNOTATION_ANNOTATION', 'targets' => Target::TARGET_ANNOTATION, 'default_property' => 'name', 'properties' => ['name' => 'name', 'type' => 'type', 'required' => 'required'], 'attribute_types' => ['value' => ['required' => true, 'type' => 'string', 'value' => 'string'], 'type' => ['required' => true, 'type' => 'string', 'value' => 'string'], 'required' => ['required' => false, 'type' => 'boolean', 'value' => 'boolean']]], \BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Attributes::class => ['is_annotation' => true, 'has_constructor' => false, 'has_named_argument_constructor' => false, 'targets_literal' => 'ANNOTATION_CLASS', 'targets' => Target::TARGET_CLASS, 'default_property' => 'value', 'properties' => ['value' => 'value'], 'attribute_types' => ['value' => ['type' => 'array', 'required' => true, 'array_type' => \BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Attribute::class, 'value' => 'array<' . \BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Attribute::class . '>']]], \BeyondSEODeps\Doctrine\Common\Annotations\Annotation\Enum::class => ['is_annotation' => true, 'has_constructor' => true, 'has_named_argument_constructor' => false, 'targets_literal' => 'ANNOTATION_PROPERTY', 'targets' => Target::TARGET_PROPERTY, 'default_property' => 'value', 'properties' => ['value' => 'value'], 'attribute_types' => ['value' => ['type' => 'array', 'required' => true], 'literal' => ['type' => 'array', 'required' => false]]], \BeyondSEODeps\Doctrine\Common\Annotations\Annotation\NamedArgumentConstructor::class => ['is_annotation' => true, 'has_constructor' => false, 'has_named_argument_constructor' => false, 'targets_literal' => 'ANNOTATION_CLASS', 'targets' => Target::TARGET_CLASS, 'default_property' => null, 'properties' => [], 'attribute_types' => []]];
    /**
    ...
    private function Annotation()
    {
        ...
        if (self::$annotationMetadata[$name]['is_annotation'] === false) {
            ...
            EXCEPTION, $name, $name, $originalName, $this->context));
        }
        ...
        if ((self::$annotationMetadata[$name]['targets'] & $target) === 0 && $target) {
            ...
            EXCEPTION, $originalName, $this->context, self::$annotationMetadata[$name]['targets_literal']));
        }
            ...
            if (PHP_VERSION_ID >= 80000) {
                foreach ($values as $property => $value) {
                    if (!isset(self::$annotationMetadata[$name]['constructor_args'][$property])) {
                        ...
                        EXCEPTION, $originalName, $this->context, $property, implode(', ', array_keys(self::$annotationMetadata[$name]['constructor_args']))));
                    }
                }
        ...
        foreach ($values as $property => $value) {
            if (!isset(self::$annotationMetadata[$name]['properties'][$property])) {
                if ($property !== 'value') {
                    ...
                    EXCEPTION, $originalName, $this->context, $property, implode(', ', self::$annotationMetadata[$name]['properties'])));
                }
