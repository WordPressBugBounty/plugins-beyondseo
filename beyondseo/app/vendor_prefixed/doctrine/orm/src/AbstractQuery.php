...
use BeyondSEODeps\Doctrine\ORM\Cache\Logging\CacheLogger;
use BeyondSEODeps\Doctrine\ORM\Cache\QueryCacheKey;
use BeyondSEODeps\Doctrine\ORM\Cache\TimestampCacheKey;
...
abstract class AbstractQuery
{
     ...
     *
     * @param \BeyondSEODeps\Doctrine\Common\Cache\Cache|null $resultCacheDriver Cache driver
     *
     * @return $this
     *
    ...
    public function setResultCacheDriver($resultCacheDriver = null)
    {
        ...
        if ($resultCacheDriver !== null && ! ($resultCacheDriver instanceof \BeyondSEODeps\Doctrine\Common\Cache\Cache)) {
     ...
     * @deprecated
     *
     * @return \BeyondSEODeps\Doctrine\Common\Cache\Cache Cache driver
     */
