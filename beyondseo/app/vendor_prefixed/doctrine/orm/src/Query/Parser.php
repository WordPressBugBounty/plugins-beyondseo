...
use BeyondSEODeps\Doctrine\ORM\Query\Exec\SqlFinalizer;
use LogicException;
use ReflectionClass;
...
class Parser
{
     ...
     */
    private function fixIdentificationVariableOrder(\BeyondSEODeps\Doctrine\ORM\Query\AST\Node $AST): void
    {
     ...
     */
    private function processDeferredNewObjectExpressions(\BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement $AST): void
    {
