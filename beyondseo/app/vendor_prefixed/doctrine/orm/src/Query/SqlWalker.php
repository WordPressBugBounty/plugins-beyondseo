...
namespace BeyondSEODeps\Doctrine\ORM\Query;

use BadMethodCallException;
use BeyondSEODeps\Doctrine\DBAL\Connection;
use BeyondSEODeps\Doctrine\DBAL\LockMode;
...
use BeyondSEODeps\Doctrine\ORM\Mapping\QuoteStrategy;
use BeyondSEODeps\Doctrine\ORM\OptimisticLockException;
use BeyondSEODeps\Doctrine\ORM\Query;
use BeyondSEODeps\Doctrine\ORM\Utility\HierarchyDiscriminatorResolver;
use BeyondSEODeps\Doctrine\ORM\Utility\PersisterHelper;
...
class SqlWalker implements TreeWalker
{
    ...
    {
        switch (true) {
            case $AST instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\DeleteStatement:
                return $this->createDeleteStatementExecutor($AST);
            case $AST instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\UpdateStatement:
                return $this->createUpdateStatementExecutor($AST);
            default:
                return new Exec\SingleSelectExecutor($AST, $this);
        }
    }
    protected function createUpdateStatementExecutor(\BeyondSEODeps\Doctrine\ORM\Query\AST\UpdateStatement $AST): \BeyondSEODeps\Doctrine\ORM\Query\Exec\AbstractSqlExecutor
    {
    ...
    protected function createDeleteStatementExecutor(\BeyondSEODeps\Doctrine\ORM\Query\AST\DeleteStatement $AST): \BeyondSEODeps\Doctrine\ORM\Query\Exec\AbstractSqlExecutor
    {
     ...
     * @return string
     */
    public function walkSelectStatement(\BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement $AST)
    {
        $sql = $this->createSqlForFinalizer($AST);
        $finalizer = new Exec\SingleSelectSqlFinalizer($sql);
        return $finalizer->finalizeSql($this->query);
    }
    protected function createSqlForFinalizer(\BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement $AST): string
    {
     ...
     * @return string
     */
    public function walkUpdateStatement(\BeyondSEODeps\Doctrine\ORM\Query\AST\UpdateStatement $AST)
    {
     ...
     * @return string
     */
    public function walkDeleteStatement(\BeyondSEODeps\Doctrine\ORM\Query\AST\DeleteStatement $AST)
    {
        $this->useSqlTableAliases = false;
        $this->rsm->isSelect = false;
    ...
    public function walkPathExpression($pathExpr)
    {
        ...
        switch ($pathExpr->type) {
            case \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD:
                ...
                break;
            case \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION:
                // 1- the owning side:
     ...
     */
    private function generateRangeVariableDeclarationSQL(\BeyondSEODeps\Doctrine\ORM\Query\AST\RangeVariableDeclaration $rangeVariableDeclaration, bool $buildNestedJoins): string
    {
     ...
     * @not-deprecated
     */
    public function walkJoinAssociationDeclaration($joinAssociationDeclaration, $joinType = \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_INNER, $condExpr = null)
    {
        $sql = '';
        ...
        switch (true) {
            ...
            case $assoc['type'] === ClassMetadata::MANY_TO_MANY:
                ...
                // Join target table
                $sql .= $joinType === \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFT || $joinType === \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFTOUTER ? ' LEFT JOIN ' : ' INNER JOIN ';
                $conditions = [];
    ...
    public function walkOrderByItem($orderByItem)
    {
        ...
        $sql = $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node ? $expr->dispatch($this) : $this->walkResultVariable($this->queryComponents[$expr]['token']->value);
        $this->orderedColumnsMap[$sql] = $type;
        if ($expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Subselect) {
            return '(' . $sql . ') ' . $type;
        }
        return $sql . ' ' . $type;
    }
    ...
    public function walkJoin($join)
    {
        ...
        $sql = $joinType === \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFT || $joinType === \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFTOUTER ? ' LEFT JOIN ' : ' INNER JOIN ';
        switch (true) {
            case $joinDeclaration instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\RangeVariableDeclaration:
                ...
                $condExprConjunction = $class->isInheritanceTypeJoined() && $joinType !== \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFT && $joinType !== \BeyondSEODeps\Doctrine\ORM\Query\AST\Join::JOIN_TYPE_LEFTOUTER && $isUnconditionalJoin ? ' AND ' : ' ON ';
                ...
                break;
            case $joinDeclaration instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\JoinAssociationDeclaration:
     ...
     * @not-deprecated
     */
    public function walkGeneralCaseExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\GeneralCaseExpression $generalCaseExpression)
    {
        $sql = 'CASE';
    ...
    public function walkSelectExpression($selectExpression)
    {
        ...
        switch (true) {
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression:
                if ($expr->type !== \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD) {
                ...
                break;
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\AggregateExpression:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\FunctionNode:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\SimpleArithmeticExpression:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ArithmeticTerm:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ArithmeticFactor:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ParenthesisExpression:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Literal:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\NullIfExpression:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\CoalesceExpression:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\GeneralCaseExpression:
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\SimpleCaseExpression:
                ...
                break;
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Subselect:
                $columnAlias = $this->getSQLColumnAlias('sclr');
                $resultAlias = $selectExpression->fieldIdentificationVariable ?: $this->scalarResultCounter++;
                ...
                break;
            case $expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\NewObjectExpression:
                $sql .= $this->walkNewObject($expr, $selectExpression->fieldIdentificationVariable);
                break;
            default:
                // IdentificationVariable or PartialObjectExpression
                if ($expr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\PartialObjectExpression) {
    ...
    /** @return string */
    public function walkParenthesisExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\ParenthesisExpression $parenthesisExpression)
    {
    ...
    public function walkNewObject($newObjectExpression, $newObjectResultAlias = null)
    {
        ...
        foreach ($newObjectExpression->args as $argIndex => $e) {
            ...
            $fieldType = 'string';
            switch (true) {
                case $e instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\NewObjectExpression:
                    $sqlSelectExpressions[] = $e->dispatch($this);
                    break;
                case $e instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Subselect:
                    $sqlSelectExpressions[] = '(' . $e->dispatch($this) . ') AS ' . $columnAlias;
                    break;
                case $e instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression:
                    assert($e->field !== null);
                    ...
                    break;
                case $e instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Literal:
                    switch ($e->type) {
                        case \BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::BOOLEAN:
                            $fieldType = 'boolean';
                            break;
                        case \BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::NUMERIC:
    ...
    public function walkGroupByItem($groupByItem)
    {
        ...
        if (isset($this->queryComponents[$groupByItem]['resultVariable'])) {
            ...
            if ($resultVariable instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression) {
                return $this->walkPathExpression($resultVariable);
            }
            if ($resultVariable instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node && isset($resultVariable->pathExpression)) {
        ...
        foreach ($this->getMetadataForDqlAlias($groupByItem)->fieldNames as $field) {
            $item = new AST\PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD, $groupByItem, $field);
            $item->type = \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_STATE_FIELD;
        ...
        foreach ($this->getMetadataForDqlAlias($groupByItem)->associationMappings as $mapping) {
            if ($mapping['isOwningSide'] && $mapping['type'] & ClassMetadata::TO_ONE) {
                $item = new AST\PathExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION, $groupByItem, $mapping['fieldName']);
                $item->type = \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression::TYPE_SINGLE_VALUED_ASSOCIATION;
                $sqlParts[] = $this->walkPathExpression($item);
            }
        }
        return implode(', ', $sqlParts);
     ...
     * @not-deprecated
     */
    public function walkDeleteClause(\BeyondSEODeps\Doctrine\ORM\Query\AST\DeleteClause $deleteClause)
    {
    ...
    public function walkUpdateItem($updateItem)
    {
        ...
        switch (true) {
            case $newValue instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node:
    ...
    public function walkConditionalExpression($condExpr)
    {
        ...
        if (!$condExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ConditionalExpression) {
    ...
    public function walkConditionalTerm($condTerm)
    {
        ...
        if (!$condTerm instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ConditionalTerm) {
    ...
    public function walkConditionalFactor($factor)
    {
        ...
        return !$factor instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ConditionalFactor ? $this->walkConditionalPrimary($factor) : ($factor->not ? 'NOT ' : '') . $this->walkConditionalPrimary($factor->conditionalPrimary);
    }
    /**
    ...
    public function walkCollectionMemberExpression($collMemberExpr)
    {
        ...
        switch (true) {
            // InputParameter
            case $entityExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InputParameter:
                $dqlParamKey = $entityExpr->name;
                $entitySql = '?';
                break;
            // SingleValuedAssociationPathExpression | IdentificationVariable
            case $entityExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression:
    ...
    public function walkNullComparisonExpression($nullCompExpr)
    {
        ...
        if ($expression instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InputParameter) {
    ...
    public function walkInExpression($inExpr)
    {
        ...
        if ($inExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InListExpression) {
            return $this->walkInListExpression($inExpr);
        }
        if ($inExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InSubselectExpression) {
     ...
     * Walks down an InExpression AST node, thereby generating the appropriate SQL.
     */
    public function walkInListExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\InListExpression $inExpr): string
    {
     ...
     * Walks down an InExpression AST node, thereby generating the appropriate SQL.
     */
    public function walkInSubselectExpression(\BeyondSEODeps\Doctrine\ORM\Query\AST\InSubselectExpression $inExpr): string
    {
        /** @phpstan-ignore property.deprecatedClass */
    ...
    {
        return $inParam instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InputParameter ? $this->walkInputParameter($inParam) : $this->walkArithmeticExpression($inParam);
    }
    /**
    ...
    {
        switch ($literal->type) {
            case \BeyondSEODeps\Doctrine\ORM\Query\AST\Literal::STRING:
    ...
    public function walkLikeExpression($likeExpr)
    {
        ...
        if ($likeExpr->stringPattern instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InputParameter) {
            $sql .= $this->walkInputParameter($likeExpr->stringPattern);
        } elseif ($likeExpr->stringPattern instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\FunctionNode) {
            $sql .= $this->walkFunction($likeExpr->stringPattern);
        } elseif ($likeExpr->stringPattern instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\PathExpression) {
    ...
    public function walkComparisonExpression($compExpr)
    {
        ...
        $sql = '';
        $sql .= $leftExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node ? $leftExpr->dispatch($this) : (is_numeric($leftExpr) ? $leftExpr : $this->conn->quote($leftExpr));
        $sql .= ' ' . $compExpr->operator . ' ';
        $sql .= $rightExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node ? $rightExpr->dispatch($this) : (is_numeric($rightExpr) ? $rightExpr : $this->conn->quote($rightExpr));
        return $sql;
    }
    /**
    ...
    {
        if (!$simpleArithmeticExpr instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\SimpleArithmeticExpression) {
    ...
    public function walkArithmeticTerm($term)
    {
        ...
        if (!$term instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ArithmeticTerm) {
    ...
    public function walkArithmeticFactor($factor)
    {
        ...
        if (!$factor instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\ArithmeticFactor) {
    ...
    {
        if ($primary instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\SimpleArithmeticExpression) {
            return '(' . $this->walkSimpleArithmeticExpression($primary) . ')';
        }
        if ($primary instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\Node) {
     ...
     * @throws QueryException
     */
    private function getChildDiscriminatorsFromClassMetadata(ClassMetadata $rootClass, \BeyondSEODeps\Doctrine\ORM\Query\AST\InstanceOfExpression $instanceOfExpr): string
    {
        $sqlParameterList = [];
        $discriminators = [];
        foreach ($instanceOfExpr->value as $parameter) {
            if ($parameter instanceof \BeyondSEODeps\Doctrine\ORM\Query\AST\InputParameter) {
