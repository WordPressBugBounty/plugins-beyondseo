...
use BeyondSEODeps\Doctrine\Common\Annotations\AnnotationReader;
use BeyondSEODeps\Doctrine\Common\Annotations\CachedReader;
use BeyondSEODeps\Doctrine\Common\Annotations\SimpleAnnotationReader;
use BeyondSEODeps\Doctrine\Common\Cache\ArrayCache;
use BeyondSEODeps\Doctrine\Common\Cache\Cache as CacheDriver;
use BeyondSEODeps\Doctrine\Common\Cache\Psr6\CacheAdapter;
use BeyondSEODeps\Doctrine\Common\Cache\Psr6\DoctrineProvider;
use BeyondSEODeps\Doctrine\Common\Persistence\PersistentObject;
use BeyondSEODeps\Doctrine\DBAL\Platforms\AbstractPlatform;
use BeyondSEODeps\Doctrine\Deprecations\Deprecation;
use BeyondSEODeps\Doctrine\ORM\Cache\CacheConfiguration;
use BeyondSEODeps\Doctrine\ORM\Cache\Exception\CacheException;
...
use BeyondSEODeps\Doctrine\ORM\Internal\Hydration\AbstractHydrator;
use BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata;
use BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadataFactory;
use BeyondSEODeps\Doctrine\ORM\Mapping\DefaultEntityListenerResolver;
use BeyondSEODeps\Doctrine\ORM\Mapping\DefaultNamingStrategy;
use BeyondSEODeps\Doctrine\ORM\Mapping\DefaultQuoteStrategy;
use BeyondSEODeps\Doctrine\ORM\Mapping\Driver\AnnotationDriver;
use BeyondSEODeps\Doctrine\ORM\Mapping\EntityListenerResolver;
use BeyondSEODeps\Doctrine\ORM\Mapping\NamingStrategy;
use BeyondSEODeps\Doctrine\ORM\Mapping\QuoteStrategy;
use BeyondSEODeps\Doctrine\ORM\Mapping\TypedFieldMapper;
use BeyondSEODeps\Doctrine\ORM\Proxy\ProxyFactory;
use BeyondSEODeps\Doctrine\ORM\Query\AST\Functions\FunctionNode;
use BeyondSEODeps\Doctrine\ORM\Query\Filter\SQLFilter;
use BeyondSEODeps\Doctrine\ORM\Query\ResultSetMapping;
use BeyondSEODeps\Doctrine\ORM\Repository\DefaultRepositoryFactory;
 ...
 */
class Configuration extends \BeyondSEODeps\Doctrine\DBAL\Configuration
{
    /** @var mixed[] */
    ...
    public function newDefaultAnnotationDriver($paths = [], $useSimpleAnnotationReader = true, bool $reportFieldsWhereDeclared = false)
    {
        ...
        if ($useSimpleAnnotationReader) {
            ...
            $reader->addNamespace('BeyondSEODeps\Doctrine\ORM\Mapping');
        } else {
