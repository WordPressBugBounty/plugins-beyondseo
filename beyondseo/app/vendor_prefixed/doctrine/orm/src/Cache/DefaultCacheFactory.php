...
use BeyondSEODeps\Doctrine\Common\Cache\Cache as LegacyCache;
use BeyondSEODeps\Doctrine\Common\Cache\Psr6\CacheAdapter;
use BeyondSEODeps\Doctrine\Deprecations\Deprecation;
use BeyondSEODeps\Doctrine\ORM\Cache;
use BeyondSEODeps\Doctrine\ORM\Cache\Persister\Collection\NonStrictReadWriteCachedCollectionPersister;
use BeyondSEODeps\Doctrine\ORM\Cache\Persister\Collection\ReadOnlyCachedCollectionPersister;
use BeyondSEODeps\Doctrine\ORM\Cache\Persister\Collection\ReadWriteCachedCollectionPersister;
use BeyondSEODeps\Doctrine\ORM\Cache\Persister\Entity\NonStrictReadWriteCachedEntityPersister;
use BeyondSEODeps\Doctrine\ORM\Cache\Persister\Entity\ReadOnlyCachedEntityPersister;
use BeyondSEODeps\Doctrine\ORM\Cache\Persister\Entity\ReadWriteCachedEntityPersister;
use BeyondSEODeps\Doctrine\ORM\Cache\Region\DefaultRegion;
use BeyondSEODeps\Doctrine\ORM\Cache\Region\FileLockRegion;
use BeyondSEODeps\Doctrine\ORM\Cache\Region\UpdateTimestampCache;
        ...
        if ($cache['usage'] === ClassMetadata::CACHE_USAGE_READ_WRITE) {
            if (
                ...
                throw new LogicException(
                    'If you want to use a "READ_WRITE" cache an implementation of "BeyondSEODeps\Doctrine\ORM\Cache\ConcurrentRegion" is required, ' .
                    'The default implementation provided by doctrine is "BeyondSEODeps\Doctrine\ORM\Cache\Region\FileLockRegion" if you want to use it please provide a valid directory, DefaultCacheFactory#setFileLockRegionDirectory(). '
                );
            }
