...
use BeyondSEODeps\Doctrine\Common\Collections\ArrayCollection;
use BeyondSEODeps\Doctrine\Common\Collections\Collection;
use BeyondSEODeps\Doctrine\Common\EventManager;
...
use BeyondSEODeps\Doctrine\ORM\Event\ListenersInvoker;
use BeyondSEODeps\Doctrine\ORM\Event\OnFlushEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PostFlushEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PostPersistEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PostRemoveEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PostUpdateEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PreFlushEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PrePersistEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PreRemoveEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\PreUpdateEventArgs;
use BeyondSEODeps\Doctrine\ORM\Exception\EntityIdentityCollisionException;
use BeyondSEODeps\Doctrine\ORM\Exception\ORMException;
use BeyondSEODeps\Doctrine\ORM\Exception\UnexpectedAssociationValue;
use BeyondSEODeps\Doctrine\ORM\Id\AssignedGenerator;
use BeyondSEODeps\Doctrine\ORM\Internal\HydrationCompleteHandler;
use BeyondSEODeps\Doctrine\ORM\Internal\StronglyConnectedComponents;
use BeyondSEODeps\Doctrine\ORM\Internal\TopologicalSort;
use BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata;
use BeyondSEODeps\Doctrine\ORM\Mapping\MappingException;
use BeyondSEODeps\Doctrine\ORM\Mapping\Reflection\ReflectionPropertiesGetter;
use BeyondSEODeps\Doctrine\ORM\Persisters\Collection\CollectionPersister;
use BeyondSEODeps\Doctrine\ORM\Persisters\Collection\ManyToManyPersister;
use BeyondSEODeps\Doctrine\ORM\Persisters\Collection\OneToManyPersister;
use BeyondSEODeps\Doctrine\ORM\Persisters\Entity\BasicEntityPersister;
use BeyondSEODeps\Doctrine\ORM\Persisters\Entity\EntityPersister;
use BeyondSEODeps\Doctrine\ORM\Persisters\Entity\JoinedSubclassPersister;
use BeyondSEODeps\Doctrine\ORM\Persisters\Entity\SingleTablePersister;
use BeyondSEODeps\Doctrine\ORM\Proxy\InternalProxy;
use BeyondSEODeps\Doctrine\ORM\Utility\IdentifierFlattener;
use BeyondSEODeps\Doctrine\Persistence\Mapping\RuntimeReflectionService;
use BeyondSEODeps\Doctrine\Persistence\NotifyPropertyChanged;
use BeyondSEODeps\Doctrine\Persistence\ObjectManagerAware;
use BeyondSEODeps\Doctrine\Persistence\PropertyChangedListener;
use Exception;
use InvalidArgumentException;
use RuntimeException;
use BeyondSEODeps\Symfony\Component\VarExporter\Hydrator;
...
class UnitOfWork implements PropertyChangedListener
{
        ...
        if (!isset($this->originalEntityData[$oid])) {
            ...
            foreach ($actualData as $propName => $actualValue) {
                ...
                if (!empty($class->fieldMappings[$propName]['enumType'])) {
                    ...
                    } else if ($orgValue instanceof BackedEnum) {
    ...
    public function addToIdentityMap($entity)
    {
        ...
        if (isset($this->identityMap[$className][$idHash])) {
            if ($this->identityMap[$className][$idHash] !== $entity) {
                ...
                \BeyondSEODeps\Doctrine\ORM\Configuration::setRejectIdCollisionInIdentityMap on the entity
                manager's configuration.
                EXCEPTION, get_class($entity), $idHash, get_class($this->identityMap[$className][$idHash]));
            }
            return false;
        }
    ...
    public function createEntity($className, array $data, &$hints = [])
    {
        ...
        if (isset($this->identityMap[$class->rootEntityName][$idHash])) {
            ...
            } else if (!isset($hints[Query::HINT_REFRESH]) || isset($hints[Query::HINT_REFRESH_ENTITY]) && $hints[Query::HINT_REFRESH_ENTITY] !== $entity) {
                return $entity;
            }
            ...
            switch (true) {
                ...
                default:
                    ...
                    if ($hints['fetchMode'][$class->name][$field] === ClassMetadata::FETCH_EAGER) {
                        if ($assoc['type'] === ClassMetadata::ONE_TO_MANY && !(isset($hints[Query::HINT_INTERNAL_ITERATION]) && $hints[Query::HINT_INTERNAL_ITERATION]) && !($targetClass->hasAssociation($assoc['mappedBy']) && count($targetClass->getAssociationMapping($assoc['mappedBy'])['joinColumns'] ?? []) > 1) && !isset($assoc['indexBy'])) {
