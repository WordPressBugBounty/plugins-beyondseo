...
namespace BeyondSEODeps\Doctrine\ORM\Mapping\Builder;
...
class FieldBuilder
{
    ...
    public function build()
    {
        ...
        if ($this->generatedValue) {
            $cm->setIdGeneratorType(constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::GENERATOR_TYPE_' . $this->generatedValue));
        }
