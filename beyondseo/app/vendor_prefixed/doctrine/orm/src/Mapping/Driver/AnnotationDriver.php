    ...
    public function loadMetadataForClass($className, PersistenceClassMetadata $metadata)
    {
        ...
        if (isset($classAnnotations[Mapping\Cache::class])) {
            ...
            $cacheMap   = [
                ...
                'usage'  => (int) constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::CACHE_USAGE_' . $cacheAnnot->usage),
            ];
        ...
        if (isset($classAnnotations[Mapping\InheritanceType::class])) {
            ...
            $metadata->setInheritanceType(
                constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::INHERITANCE_TYPE_' . $inheritanceTypeAnnot->value)
            );
        ...
        if (isset($classAnnotations[Mapping\ChangeTrackingPolicy::class])) {
            ...
            $metadata->setChangeTrackingPolicy(constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::CHANGETRACKING_' . $changeTrackingAnnot->value));
        }
        ...
        foreach ($class->getProperties() as $property) {
            ...
            if ($columnAnnot) {
                ...
                if ($generatedValueAnnot) {
                    $metadata->setIdGeneratorType(constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::GENERATOR_TYPE_' . $generatedValueAnnot->strategy));
                }
