...
class YamlDriver extends FileDriver
{
    ...
    public function loadMetadataForClass($className, PersistenceClassMetadata $metadata)
    {
        ...
        if (isset($element['inheritanceType'])) {
            $metadata->setInheritanceType(constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::INHERITANCE_TYPE_' . strtoupper($element['inheritanceType'])));
        ...
        if (isset($element['oneToOne'])) {
            foreach ($element['oneToOne'] as $name => $oneToOneElement) {
                ...
                if (isset($oneToOneElement['fetch'])) {
                    $mapping['fetch'] = constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::FETCH_' . $oneToOneElement['fetch']);
                }
        ...
        if (isset($element['oneToMany'])) {
            foreach ($element['oneToMany'] as $name => $oneToManyElement) {
                ...
                if (isset($oneToManyElement['fetch'])) {
                    $mapping['fetch'] = constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::FETCH_' . $oneToManyElement['fetch']);
                }
        ...
        if (isset($element['manyToOne'])) {
            foreach ($element['manyToOne'] as $name => $manyToOneElement) {
                ...
                if (isset($manyToOneElement['fetch'])) {
                    $mapping['fetch'] = constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::FETCH_' . $manyToOneElement['fetch']);
                }
        ...
        if (isset($element['manyToMany'])) {
            foreach ($element['manyToMany'] as $name => $manyToManyElement) {
                ...
                if (isset($manyToManyElement['fetch'])) {
                    $mapping['fetch'] = constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::FETCH_' . $manyToManyElement['fetch']);
                }
        ...
        if (isset($element['lifecycleCallbacks'])) {
            foreach ($element['lifecycleCallbacks'] as $type => $methods) {
                foreach ($methods as $method) {
                    $metadata->addLifecycleCallback($method, constant('BeyondSEODeps\Doctrine\ORM\Events::' . $type));
                }
            }
        }
    ...
    private function columnToArray(string $fieldName, ?array $column): array
    {
        ...
        if (isset($column['generated'])) {
            $mapping['generated'] = constant('BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata::GENERATED_' . $column['generated']);
        }
