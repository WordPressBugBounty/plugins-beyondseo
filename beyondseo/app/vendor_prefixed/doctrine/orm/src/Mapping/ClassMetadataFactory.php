...
use BeyondSEODeps\Doctrine\DBAL\Platforms;
...
use BeyondSEODeps\Doctrine\ORM\Event\LoadClassMetadataEventArgs;
use BeyondSEODeps\Doctrine\ORM\Event\OnClassMetadataNotFoundEventArgs;
...
use BeyondSEODeps\Doctrine\ORM\Id\BigIntegerIdentityGenerator;
use BeyondSEODeps\Doctrine\ORM\Id\IdentityGenerator;
use BeyondSEODeps\Doctrine\ORM\Id\SequenceGenerator;
use BeyondSEODeps\Doctrine\ORM\Id\UuidGenerator;
use BeyondSEODeps\Doctrine\ORM\Mapping\Exception\CannotGenerateIds;
use BeyondSEODeps\Doctrine\ORM\Mapping\Exception\InvalidCustomGenerator;
use BeyondSEODeps\Doctrine\ORM\Mapping\Exception\UnknownGeneratorType;
use BeyondSEODeps\Doctrine\ORM\Proxy\DefaultProxyClassNameResolver;
use BeyondSEODeps\Doctrine\Persistence\Mapping\AbstractClassMetadataFactory;
use BeyondSEODeps\Doctrine\Persistence\Mapping\ClassMetadata as ClassMetadataInterface;
use BeyondSEODeps\Doctrine\Persistence\Mapping\Driver\MappingDriver;
use BeyondSEODeps\Doctrine\Persistence\Mapping\ReflectionService;
use ReflectionClass;
...
class ClassMetadataFactory extends AbstractClassMetadataFactory
{
    ...
    private const NON_IDENTITY_DEFAULT_STRATEGY = [
        'BeyondSEODeps\Doctrine\DBAL\Platforms\PostgreSqlPlatform' => ClassMetadata::GENERATOR_TYPE_SEQUENCE,
...
DEPRECATION
    ...
    private function determineIdGeneratorStrategy(AbstractPlatform $platform): int
    {
        ...
        foreach (self::NON_IDENTITY_DEFAULT_STRATEGY as $platformFamily => $strategy) {
            if (is_a($platform, $platformFamily)) {
                if ($platform instanceof Platforms\PostgreSQLPlatform || is_a($platform, 'BeyondSEODeps\Doctrine\DBAL\Platforms\PostgreSqlPlatform')) {
                    Deprecation::trigger(
                        'doctrine/orm',
