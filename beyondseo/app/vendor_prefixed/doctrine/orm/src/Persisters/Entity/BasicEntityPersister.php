...
namespace BeyondSEODeps\Doctrine\ORM\Persisters\Entity;

use BeyondSEODeps\Doctrine\Common\Collections\Criteria;
use BeyondSEODeps\Doctrine\Common\Collections\Expr\Comparison;
...
use BeyondSEODeps\Doctrine\ORM\Internal\CriteriaOrderings;
...
use BeyondSEODeps\Doctrine\ORM\Persisters\SqlExpressionVisitor;
use BeyondSEODeps\Doctrine\ORM\Persisters\SqlValueVisitor;
...
use BeyondSEODeps\Doctrine\ORM\Utility\LockSqlHelper;
...
class BasicEntityPersister implements EntityPersister
{
    ...
    public function executeInserts()
    {
        ...
        foreach ($this->queuedInserts as $key => $entity) {
            ...
            // from its own list (\BeyondSEODeps\Doctrine\ORM\UnitOfWork::$entityInsertions) right after they
