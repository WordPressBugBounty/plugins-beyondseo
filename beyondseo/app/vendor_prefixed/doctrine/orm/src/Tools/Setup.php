...
namespace BeyondSEODeps\Doctrine\ORM\Tools;

use BeyondSEODeps\Doctrine\Common\Cache\ApcuCache;
use BeyondSEODeps\Doctrine\Common\Cache\ArrayCache;
use BeyondSEODeps\Doctrine\Common\Cache\Cache;
use BeyondSEODeps\Doctrine\Common\Cache\CacheProvider;
use BeyondSEODeps\Doctrine\Common\Cache\MemcachedCache;
use BeyondSEODeps\Doctrine\Common\Cache\Psr6\CacheAdapter;
use BeyondSEODeps\Doctrine\Common\Cache\Psr6\DoctrineProvider;
use BeyondSEODeps\Doctrine\Common\Cache\RedisCache;
use BeyondSEODeps\Doctrine\Common\ClassLoader;
use BeyondSEODeps\Doctrine\Deprecations\Deprecation;
use BeyondSEODeps\Doctrine\ORM\Configuration;
use BeyondSEODeps\Doctrine\ORM\Mapping\Driver\AttributeDriver;
use BeyondSEODeps\Doctrine\ORM\Mapping\Driver\XmlDriver;
use BeyondSEODeps\Doctrine\ORM\Mapping\Driver\YamlDriver;
...
use BeyondSEODeps\Symfony\Component\Cache\Adapter\MemcachedAdapter;
use BeyondSEODeps\Symfony\Component\Cache\Adapter\RedisAdapter;
...
class Setup
{
    ...
    {
        if (! class_exists('BeyondSEODeps\Doctrine\Common\ClassLoader', false)) {
