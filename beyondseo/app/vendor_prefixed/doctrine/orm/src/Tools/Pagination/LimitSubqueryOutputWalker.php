...
use BeyondSEODeps\Doctrine\DBAL\Platforms\SQLAnywherePlatform;
...
use BeyondSEODeps\Doctrine\ORM\Query\AST\SelectExpression;
use BeyondSEODeps\Doctrine\ORM\Query\AST\SelectStatement;
use BeyondSEODeps\Doctrine\ORM\Query\AST\UpdateStatement;
use BeyondSEODeps\Doctrine\ORM\Query\Exec\SingleSelectSqlFinalizer;
...
use BeyondSEODeps\Doctrine\ORM\Query\SqlOutputWalker;
use LogicException;
...
class LimitSubqueryOutputWalker extends SqlOutputWalker
{
     ...
     * because BeyondSEODeps\Doctrine\ORM\Query\SqlWalker keeps everything private without
     * accessors.
     *
     * @param Query        $query
