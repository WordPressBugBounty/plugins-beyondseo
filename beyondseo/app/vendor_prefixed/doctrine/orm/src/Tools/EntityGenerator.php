 ...
 *
 *     $generator = new \BeyondSEODeps\Doctrine\ORM\Tools\EntityGenerator();
...
';
    ...
    protected function generateEntityConstructor(ClassMetadataInfo $metadata)
    {
        ...
        foreach ($metadata->associationMappings as $mapping) {
            if ($mapping['type'] & ClassMetadataInfo::TO_MANY) {
                $collections[] = '$this->' . $mapping['fieldName'] . ' = new \BeyondSEODeps\Doctrine\Common\Collections\ArrayCollection();';
            }
        }
    ...
    protected function generateAssociationMappingPropertyDocBlock(array $associationMapping, ClassMetadataInfo $metadata)
    {
        ...
        if ($associationMapping['type'] & ClassMetadataInfo::TO_MANY) {
            $lines[] = $this->spaces . ' * @var \BeyondSEODeps\Doctrine\Common\Collections\Collection';
        } else {
