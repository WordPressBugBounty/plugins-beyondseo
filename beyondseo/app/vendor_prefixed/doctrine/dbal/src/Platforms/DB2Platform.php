...
use BeyondSEODeps\Doctrine\DBAL\Schema\DB2SchemaManager;
...
class DB2Platform extends AbstractPlatform
{
    ...
    protected function getVarcharTypeDeclarationSQLSnippet($length, $fixed)
    {
        if ($length <= 0 || func_num_args() > 2 && func_get_arg(2)) {
            Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/issues/3263', 'Relying on the default string column length on Db2 is deprecated' . ', specify the length explicitly.');
        }
    ...
    {
        if ($length <= 0 || func_num_args() > 2 && func_get_arg(2)) {
            Deprecation::trigger('doctrine/dbal', 'https://github.com/doctrine/dbal/issues/3263', 'Relying on the default binary column length on Db2 is deprecated' . ', specify the length explicitly.');
        }
    ...
    protected function getReservedKeywordsClass()
    {
        ...
        return \BeyondSEODeps\Doctrine\DBAL\Platforms\Keywords\DB2Keywords::class;
    }
    /** @deprecated The SQL used for schema introspection is an implementation detail and should not be relied upon. */
    public function getListTableCommentsSQL(string $table): string
    {
        ...
        SELECT REMARKS
          ...
          WHERE NAME = UPPER( %s )
        SQL, $this->quoteStringLiteral($table));
    }
