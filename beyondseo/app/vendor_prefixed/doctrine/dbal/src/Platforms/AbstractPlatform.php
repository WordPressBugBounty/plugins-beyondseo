...
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaAlterTableAddColumnEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaAlterTableChangeColumnEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaAlterTableEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaAlterTableRemoveColumnEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaAlterTableRenameColumnEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaCreateTableColumnEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaCreateTableEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaDropTableEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Events;
use BeyondSEODeps\Doctrine\DBAL\Exception;
use BeyondSEODeps\Doctrine\DBAL\Exception\InvalidLockMode;
use BeyondSEODeps\Doctrine\DBAL\LockMode;
use BeyondSEODeps\Doctrine\DBAL\Platforms\Keywords\KeywordList;
use BeyondSEODeps\Doctrine\DBAL\Schema\AbstractSchemaManager;
use BeyondSEODeps\Doctrine\DBAL\Schema\Column;
use BeyondSEODeps\Doctrine\DBAL\Schema\ColumnDiff;
use BeyondSEODeps\Doctrine\DBAL\Schema\Constraint;
use BeyondSEODeps\Doctrine\DBAL\Schema\ForeignKeyConstraint;
use BeyondSEODeps\Doctrine\DBAL\Schema\Identifier;
use BeyondSEODeps\Doctrine\DBAL\Schema\Index;
use BeyondSEODeps\Doctrine\DBAL\Schema\SchemaDiff;
...
use BeyondSEODeps\Doctrine\DBAL\Schema\UniqueConstraint;
use BeyondSEODeps\Doctrine\DBAL\SQL\Builder\DefaultSelectSQLBuilder;
use BeyondSEODeps\Doctrine\DBAL\SQL\Builder\SelectSQLBuilder;
use BeyondSEODeps\Doctrine\DBAL\SQL\Parser;
use BeyondSEODeps\Doctrine\DBAL\TransactionIsolationLevel;
use BeyondSEODeps\Doctrine\DBAL\Types;
