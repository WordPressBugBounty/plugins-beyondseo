...
use BeyondSEODeps\Doctrine\DBAL\Types\BinaryType;
...
END;';
    ...
    public function getListTableColumnsSQL($table, $database = null)
    {
        ...
        SQL, $colCommentsTableName, $colCommentsOwnerCondition, $tabColumnsTableName, $table, $tabColumnsOwnerCondition);
    }
    /**
     * {@inheritDoc}
     */
    ...
    protected function getReservedKeywordsClass()
    {
        ...
        return \BeyondSEODeps\Doctrine\DBAL\Platforms\Keywords\OracleKeywords::class;
    }
    /**
     * {@inheritDoc}
     */
    ...
    public function getListTableCommentsSQL(string $table, ?string $database = null): string
    {
        ...
        SQL, $tableCommentsName, $this->quoteStringLiteral($this->normalizeIdentifier($table)->getName()), $ownerCondition);
    }
