...
use BeyondSEODeps\Doctrine\DBAL\Platforms\SQLServer\SQL\Builder\SQLServerSelectSQLBuilder;
...
class SQLServerPlatform extends AbstractPlatform
{
    ...
    public function getRenameTableSQL(string $oldName, string $newName): array
    {
        return [
            ...
            SQL, $this->generateIdentifierName($oldName), $this->generateIdentifierName($newName), $this->quoteStringLiteral($newName)),
        ];
    }
    /**
    ...
    protected function getReservedKeywordsClass()
    {
        ...
        return \BeyondSEODeps\Doctrine\DBAL\Platforms\Keywords\SQLServer2012Keywords::class;
    }
    /**
     * {@inheritDoc}
     */
