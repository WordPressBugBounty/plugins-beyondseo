...
use BeyondSEODeps\Doctrine\DBAL\Driver\API\SQLite\UserDefinedFunctions;
...
use BeyondSEODeps\Doctrine\DBAL\Schema\SqliteSchemaManager;
...
use BeyondSEODeps\Doctrine\DBAL\Types\IntegerType;
...
class SqlitePlatform extends AbstractPlatform
{
    ...
    protected function getReservedKeywordsClass()
    {
        ...
        return \BeyondSEODeps\Doctrine\DBAL\Platforms\Keywords\SQLiteKeywords::class;
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        Deprecation::triggerIfCalledFromOutside('doctrine/dbal', 'https://github.com/doctrine/dbal/pull/4805', 'SqlitePlatform::canEmulateSchemas() is deprecated.');
