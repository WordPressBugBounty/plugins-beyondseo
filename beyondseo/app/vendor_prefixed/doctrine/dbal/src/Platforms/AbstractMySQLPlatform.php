...
use BeyondSEODeps\Doctrine\DBAL\Schema\AbstractAsset;
...
use BeyondSEODeps\Doctrine\DBAL\Types\BlobType;
...
abstract class AbstractMySQLPlatform extends AbstractPlatform
{
    ...
    public function getListTableMetadataSQL(string $table, ?string $database = null): string
    {
        ...
        SQL, $this->getDatabaseNameSQL($database), $this->quoteStringLiteral($table));
    }
    /**
     * {@inheritDoc}
     */
    ...
    protected function getReservedKeywordsClass()
    {
        ...
        return \BeyondSEODeps\Doctrine\DBAL\Platforms\Keywords\MySQLKeywords::class;
    }
    /**
     * {@inheritDoc}
     *
