...
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaColumnDefinitionEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\SchemaIndexDefinitionEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Events;
use BeyondSEODeps\Doctrine\DBAL\Exception;
use BeyondSEODeps\Doctrine\DBAL\Exception\DatabaseRequired;
