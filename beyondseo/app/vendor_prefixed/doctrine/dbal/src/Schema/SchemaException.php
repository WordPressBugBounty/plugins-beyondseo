...
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\ColumnAlreadyExists;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\ColumnDoesNotExist;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\ForeignKeyDoesNotExist;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\IndexAlreadyExists;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\IndexDoesNotExist;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\IndexNameInvalid;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\NamedForeignKeyRequired;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\NamespaceAlreadyExists;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\SequenceAlreadyExists;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\SequenceDoesNotExist;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\TableAlreadyExists;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\TableDoesNotExist;
use BeyondSEODeps\Doctrine\DBAL\Schema\Exception\UniqueConstraintDoesNotExist;
