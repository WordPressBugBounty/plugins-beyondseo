...
use BeyondSEODeps\Doctrine\DBAL\Driver\IBMDB2;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli;
use BeyondSEODeps\Doctrine\DBAL\Driver\OCI8;
use BeyondSEODeps\Doctrine\DBAL\Driver\PDO;
use BeyondSEODeps\Doctrine\DBAL\Driver\PgSQL;
use BeyondSEODeps\Doctrine\DBAL\Driver\SQLite3;
use BeyondSEODeps\Doctrine\DBAL\Driver\SQLSrv;
...
final class DriverManager
{
     ...
     */
    private const DRIVER_MAP = ['pdo_mysql' => PDO\MySQL\Driver::class, 'pdo_sqlite' => PDO\SQLite\Driver::class, 'pdo_pgsql' => PDO\PgSQL\Driver::class, 'pdo_oci' => PDO\OCI\Driver::class, 'oci8' => OCI8\Driver::class, 'ibm_db2' => IBMDB2\Driver::class, 'pdo_sqlsrv' => PDO\SQLSrv\Driver::class, 'mysqli' => Mysqli\Driver::class, 'pgsql' => \BeyondSEODeps\Doctrine\DBAL\Driver\PDO\PgSQL\Driver::class, 'sqlsrv' => \BeyondSEODeps\Doctrine\DBAL\Driver\PDO\SQLSrv\Driver::class, 'sqlite3' => SQLite3\Driver::class];
    /**
