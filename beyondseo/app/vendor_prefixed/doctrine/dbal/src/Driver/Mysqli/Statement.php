...
use BeyondSEODeps\Doctrine\DBAL\Driver\Exception\UnknownParameterType;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Exception\FailedReadingStreamOffset;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Exception\NonStreamResourceUsedAsLargeObject;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Exception\StatementError;
use BeyondSEODeps\Doctrine\DBAL\Driver\Result as ResultInterface;
use BeyondSEODeps\Doctrine\DBAL\Driver\Statement as StatementInterface;
