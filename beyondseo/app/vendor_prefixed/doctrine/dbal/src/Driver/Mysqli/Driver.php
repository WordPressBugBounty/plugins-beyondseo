...
use BeyondSEODeps\Doctrine\DBAL\Driver\AbstractMySQLDriver;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Exception\ConnectionFailed;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Exception\HostRequired;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Initializer\Charset;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Initializer\Options;
use BeyondSEODeps\Doctrine\DBAL\Driver\Mysqli\Initializer\Secure;
use Generator;
use mysqli;
