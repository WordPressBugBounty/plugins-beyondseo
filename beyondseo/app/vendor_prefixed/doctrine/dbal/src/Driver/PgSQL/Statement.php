...
namespace BeyondSEODeps\Doctrine\DBAL\Driver\PgSQL;

use BeyondSEODeps\Doctrine\DBAL\Driver\PgSQL\Exception\UnknownParameter;
...
use BeyondSEODeps\PgSql\Connection as PgSqlConnection;
use TypeError;
use function assert;
