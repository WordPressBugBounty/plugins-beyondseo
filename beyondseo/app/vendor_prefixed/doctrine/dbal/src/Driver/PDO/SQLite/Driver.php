...
namespace BeyondSEODeps\Doctrine\DBAL\Driver\PDO\SQLite;

use BeyondSEODeps\Doctrine\DBAL\Driver\AbstractSQLiteDriver;
use BeyondSEODeps\Doctrine\DBAL\Driver\API\SQLite\UserDefinedFunctions;
use BeyondSEODeps\Doctrine\DBAL\Driver\PDO\Connection;
use BeyondSEODeps\Doctrine\DBAL\Driver\PDO\Exception;
use BeyondSEODeps\Doctrine\DBAL\Driver\PDO\PDOConnect;
use BeyondSEODeps\Doctrine\Deprecations\Deprecation;
use BeyondSEODeps\Pdo\Sqlite;
use PDOException;
