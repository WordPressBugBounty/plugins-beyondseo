...
namespace BeyondSEODeps\Doctrine\DBAL\Driver\IBMDB2;

use BeyondSEODeps\Doctrine\DBAL\Driver\Exception;
use BeyondSEODeps\Doctrine\DBAL\Driver\IBMDB2\Exception\CannotCopyStreamToStream;
use BeyondSEODeps\Doctrine\DBAL\Driver\IBMDB2\Exception\CannotCreateTemporaryFile;
use BeyondSEODeps\Doctrine\DBAL\Driver\IBMDB2\Exception\StatementError;
