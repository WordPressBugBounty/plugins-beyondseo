...
namespace BeyondSEODeps\Doctrine\DBAL\Driver\OCI8;

use BeyondSEODeps\Doctrine\DBAL\Driver\AbstractOracleDriver;
use BeyondSEODeps\Doctrine\DBAL\Driver\OCI8\Exception\ConnectionFailed;
use BeyondSEODeps\Doctrine\DBAL\Driver\OCI8\Exception\InvalidConfiguration;
