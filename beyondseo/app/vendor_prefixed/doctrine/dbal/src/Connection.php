...
use BeyondSEODeps\Doctrine\DBAL\Cache\ArrayResult;
use BeyondSEODeps\Doctrine\DBAL\Cache\CacheException;
use BeyondSEODeps\Doctrine\DBAL\Cache\QueryCacheProfile;
...
use BeyondSEODeps\Doctrine\DBAL\Driver\Exception as TheDriverException;
use BeyondSEODeps\Doctrine\DBAL\Driver\ServerInfoAwareConnection;
use BeyondSEODeps\Doctrine\DBAL\Driver\Statement as DriverStatement;
use BeyondSEODeps\Doctrine\DBAL\Event\TransactionBeginEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\TransactionCommitEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Event\TransactionRollBackEventArgs;
use BeyondSEODeps\Doctrine\DBAL\Exception\ConnectionLost;
use BeyondSEODeps\Doctrine\DBAL\Exception\DeadlockException;
...
use BeyondSEODeps\Doctrine\DBAL\Exception\InvalidArgumentException;
...
use BeyondSEODeps\Doctrine\DBAL\Query\Expression\ExpressionBuilder;
use BeyondSEODeps\Doctrine\DBAL\Query\QueryBuilder;
use BeyondSEODeps\Doctrine\DBAL\Schema\AbstractSchemaManager;
use BeyondSEODeps\Doctrine\DBAL\Schema\DefaultSchemaManagerFactory;
use BeyondSEODeps\Doctrine\DBAL\Schema\LegacySchemaManagerFactory;
use BeyondSEODeps\Doctrine\DBAL\Schema\SchemaManagerFactory;
use BeyondSEODeps\Doctrine\DBAL\SQL\Parser;
...
class Connection
{
    ...
    )
    {
        ...
        if (isset($params['platform'])) {
            if (!$params['platform'] instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\AbstractPlatform) {
    ...
    public function connect()
    {
        ...
        } catch (\BeyondSEODeps\Doctrine\DBAL\Driver\Exception $e) {
     ...
     * @param array<int, int|string|Type|null>|array<string, int|string|Type|null> $types
     */
    final public function convertExceptionDuringQuery(\BeyondSEODeps\Doctrine\DBAL\Driver\Exception $e, string $sql, array $params = [], array $types = []): DriverException
    {
        return $this->handleDriverException($e, new Query($sql, $params, $types));
    }
    /** @internal */
    final public function convertException(\BeyondSEODeps\Doctrine\DBAL\Driver\Exception $e): DriverException
    {
    ...
    private function handleDriverException(\BeyondSEODeps\Doctrine\DBAL\Driver\Exception $driverException, ?Query $query): DriverException
    {
