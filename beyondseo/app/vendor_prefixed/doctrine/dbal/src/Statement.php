...
class Statement
{
     ...
     * @throws Exception
     */
    public function __construct(Connection $conn, \BeyondSEODeps\Doctrine\DBAL\Driver\Statement $statement, string $sql)
    {
        $this->conn = $conn;
        $this->stmt = $statement;
        $this->sql = $sql;
    ...
    public function execute($params = null): Result
    {
        ...
        } catch (\BeyondSEODeps\Doctrine\DBAL\Driver\Exception $ex) {
