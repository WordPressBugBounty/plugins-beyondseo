...
namespace BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\DependencyInjection;

use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\Attribute\AsDoctrineListener;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\Attribute\AsEntityListener;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\Attribute\AsMiddleware;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\CacheWarmer\DoctrineMetadataCacheWarmer;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\ConnectionFactory;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\Dbal\ManagerRegistryAwareConnectionProvider;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\Dbal\RegexSchemaAssetFilter;
...
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\EventSubscriber\EventSubscriberInterface;
use BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\Repository\ServiceEntityRepositoryInterface;
use BeyondSEODeps\Doctrine\Common\Annotations\Annotation;
use BeyondSEODeps\Doctrine\DBAL\Connection;
use BeyondSEODeps\Doctrine\DBAL\Connections\PrimaryReadReplicaConnection;
use BeyondSEODeps\Doctrine\DBAL\Driver\Middleware as MiddlewareInterface;
use BeyondSEODeps\Doctrine\DBAL\Schema\LegacySchemaManagerFactory;
use BeyondSEODeps\Doctrine\ORM\Configuration as OrmConfiguration;
use BeyondSEODeps\Doctrine\ORM\EntityManagerInterface;
use BeyondSEODeps\Doctrine\ORM\Events;
use BeyondSEODeps\Doctrine\ORM\Id\AbstractIdGenerator;
use BeyondSEODeps\Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver;
use BeyondSEODeps\Doctrine\ORM\Proxy\Autoloader;
use BeyondSEODeps\Doctrine\ORM\Proxy\ProxyFactory;
...
use BeyondSEODeps\Doctrine\ORM\Tools\Export\ClassMetadataExporter;
use BeyondSEODeps\Doctrine\ORM\UnitOfWork;
use BeyondSEODeps\Doctrine\Persistence\Reflection\RuntimeReflectionProperty;
use InvalidArgumentException;
use LogicException;
use BeyondSEODeps\Symfony\Bridge\Doctrine\ArgumentResolver\EntityValueResolver;
use BeyondSEODeps\Symfony\Bridge\Doctrine\Attribute\MapEntity;
use BeyondSEODeps\Symfony\Bridge\Doctrine\DependencyInjection\AbstractDoctrineExtension;
use BeyondSEODeps\Symfony\Bridge\Doctrine\IdGenerator\UlidGenerator;
use BeyondSEODeps\Symfony\Bridge\Doctrine\IdGenerator\UuidGenerator;
use BeyondSEODeps\Symfony\Bridge\Doctrine\Middleware\IdleConnection\Listener;
use BeyondSEODeps\Symfony\Bridge\Doctrine\PropertyInfo\DoctrineExtractor;
use BeyondSEODeps\Symfony\Bridge\Doctrine\SchemaListener\DoctrineDbalCacheAdapterSchemaListener;
use BeyondSEODeps\Symfony\Bridge\Doctrine\SchemaListener\LockStoreSchemaListener;
use BeyondSEODeps\Symfony\Bridge\Doctrine\SchemaListener\MessengerTransportDoctrineSchemaListener;
use BeyondSEODeps\Symfony\Bridge\Doctrine\SchemaListener\PdoCacheAdapterDoctrineSchemaSubscriber;
use BeyondSEODeps\Symfony\Bridge\Doctrine\SchemaListener\PdoSessionHandlerSchemaListener;
use BeyondSEODeps\Symfony\Bridge\Doctrine\SchemaListener\RememberMeTokenProviderDoctrineSchemaListener;
use BeyondSEODeps\Symfony\Bridge\Doctrine\Validator\DoctrineLoader;
...
use BeyondSEODeps\Symfony\Component\Messenger\Bridge\Doctrine\Transport\DoctrineTransportFactory;
...
use BeyondSEODeps\Symfony\Component\VarExporter\LazyGhostTrait;
...
class DoctrineExtension extends AbstractDoctrineExtension
{
    ...
    protected function ormLoad(array $config, ContainerBuilder $container)
    {
        ...
        if (! class_exists(EntityValueResolver::class)) {
            ...
            if ($config['controller_resolver']['auto_mapping'] === null) {
                beondseodeps_trigger_deprecation('doctrine/doctrine-bundle', '2.12', 'The default value of "doctrine.orm.controller_resolver.auto_mapping" will be changed from `true` to `false`. Explicitly configure `true` to keep existing behaviour.');
                $config['controller_resolver']['auto_mapping'] = true;
            }

            if ($config['controller_resolver']['auto_mapping'] === true) {
                beondseodeps_trigger_deprecation('doctrine/doctrine-bundle', '2.13', 'Enabling the controller resolver automapping feature has been deprecated. Symfony Mapped Route Parameters should be used as replacement.');
            }
        ...
        if ($config['enable_lazy_ghost_objects'] ?? false) {
            ...
            beondseodeps_trigger_deprecation('doctrine/doctrine-bundle', '2.11', 'Not setting "doctrine.orm.enable_lazy_ghost_objects" to true is deprecated.');
        }
     ...
     *             prefix: BeyondSEODeps\DoctrineExtensions\Entities\
     *             alias: DExt
     *
