...
class Configuration implements ConfigurationInterface
{
    ...
    private function getDbalConnectionsNode(): ArrayNodeDefinition
    {
        ...
        $collationKey = defined('BeyondSEODeps\Doctrine\DBAL\Connection::PARAM_ASCII_STR_ARRAY')
            ? 'collate'
            : 'collation';
                    ...
                    ->children()
                        ...
                        ->scalarNode('auto_generate_proxy_classes')->defaultValue(false)
                            ...
                            ->validate()
                                ->ifString()
                                ->then(static function ($v) {
                                    return constant('BeyondSEODeps\Doctrine\ORM\Proxy\ProxyFactory::AUTOGENERATE_' . strtoupper($v));
                                })
                            ->end()
                        ->end()
