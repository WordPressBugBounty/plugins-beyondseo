...
namespace BeyondSEODeps\Doctrine\Bundle\DoctrineBundle\DataCollector;

use BeyondSEODeps\Doctrine\DBAL\Types\Type;
use BeyondSEODeps\Doctrine\ORM\Cache\CacheConfiguration;
use BeyondSEODeps\Doctrine\ORM\Cache\Logging\CacheLoggerChain;
use BeyondSEODeps\Doctrine\ORM\Cache\Logging\StatisticsCacheLogger;
use BeyondSEODeps\Doctrine\ORM\EntityManagerInterface;
use BeyondSEODeps\Doctrine\ORM\Mapping\ClassMetadata;
use BeyondSEODeps\Doctrine\ORM\Tools\SchemaValidator;
...
use BeyondSEODeps\Symfony\Bridge\Doctrine\DataCollector\DoctrineDataCollector as BaseCollector;
