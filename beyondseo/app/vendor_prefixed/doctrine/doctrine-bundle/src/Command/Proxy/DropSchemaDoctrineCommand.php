...
use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\SchemaTool\DropCommand;
use BeyondSEODeps\Symfony\Component\Console\Input\InputOption;

/**
 * Command to drop the database schema for a set of classes based on their mappings.
 *
 * @deprecated use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\SchemaTool\DropCommand instead
 */
