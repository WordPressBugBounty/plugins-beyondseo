...
use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\ClearCache\ResultCommand;
use BeyondSEODeps\Symfony\Component\Console\Input\InputOption;

/**
 * Command to clear the result cache of the various cache drivers.
 *
 * @deprecated use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\ClearCache\ResultCommand instead
 */
