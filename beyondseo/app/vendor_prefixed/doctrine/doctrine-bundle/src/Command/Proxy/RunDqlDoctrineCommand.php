...
use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\RunDqlCommand;
use BeyondSEODeps\Symfony\Component\Console\Input\InputOption;

/**
 * Execute a Doctrine DQL query and output the results.
 *
 * @deprecated use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\RunDqlCommand instead
 */
