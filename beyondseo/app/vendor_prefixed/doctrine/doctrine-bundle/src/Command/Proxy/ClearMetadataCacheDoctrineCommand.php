...
use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\ClearCache\MetadataCommand;
use BeyondSEODeps\Symfony\Component\Console\Input\InputOption;

/**
 * Command to clear the metadata cache of the various cache drivers.
 *
 * @deprecated use BeyondSEODeps\Doctrine\ORM\Tools\Console\Command\ClearCache\MetadataCommand instead
 */
