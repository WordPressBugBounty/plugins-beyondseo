...
use BeyondSEODeps\Illuminate\Contracts\Bus\Dispatcher as BusDispatcherContract;
use Illuminate\Foundation\Bus\PendingChain;
use BeyondSEODeps\Illuminate\Support\Testing\Fakes\BusFake;

/**
 * @method static \BeyondSEODeps\Illuminate\Bus\Batch|null findBatch(string $batchId)
 * @method static \BeyondSEODeps\Illuminate\Bus\PendingBatch batch(array|mixed $jobs)
 * @method static \BeyondSEODeps\Illuminate\Contracts\Bus\Dispatcher map(array $map)
 * @method static \BeyondSEODeps\Illuminate\Contracts\Bus\Dispatcher pipeThrough(array $pipes)
 ...
 * @method static void assertNotDispatched(string|\Closure $command, callable|int|null $callback = null)
 ...
 *
 * @see \BeyondSEODeps\Illuminate\Contracts\Bus\Dispatcher
 */
class Bus extends Facade
{
     ...
     * @return \BeyondSEODeps\Illuminate\Support\Testing\Fakes\BusFake
     */
