...
/**
 * @method static \BeyondSEODeps\Symfony\Component\Finder\SplFileInfo[] allFiles(string $directory, bool $hidden = false)
 * @method static \BeyondSEODeps\Symfony\Component\Finder\SplFileInfo[] files(string $directory, bool $hidden = false)
 ...
 * @method static \BeyondSEODeps\Illuminate\Support\LazyCollection lines(string $path)
 * @method static void relativeLink(string $target, string $link)
 * @method static void replace(string $path, string $content)
 *
 * @see \BeyondSEODeps\Illuminate\Filesystem\Filesystem
 */
