...
use BeyondSEODeps\Illuminate\Support\Testing\Fakes\EventFake;

/**
 * @method static \Closure createClassListener(string $listener, bool $wildcard = false)
 * @method static \Closure makeListener(\Closure|string $listener, bool $wildcard = false)
 * @method static \BeyondSEODeps\Illuminate\Events\Dispatcher setQueueResolver(callable $resolver)
 ...
 * @method static void assertNotDispatched(string|\Closure $event, callable|int|null $callback = null)
 ...
 *
 * @see \BeyondSEODeps\Illuminate\Events\Dispatcher
 */
class Event extends Facade
{
     ...
     * @return \BeyondSEODeps\Illuminate\Support\Testing\Fakes\EventFake
     */
    ...
    public static function fakeFor(callable $callable, array $eventsToFake = [])
    {
        ...
        return beondseodeps_tap($callable(), function () use ($originalDispatcher) {
