 ...
 * @method static \Illuminate\Routing\Route substituteBindings(\BeyondSEODeps\Illuminate\Support\Facades\Route $route)
 ...
 * @method static void substituteImplicitBindings(\BeyondSEODeps\Illuminate\Support\Facades\Route $route)
