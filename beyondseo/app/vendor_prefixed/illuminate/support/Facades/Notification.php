...
use BeyondSEODeps\Illuminate\Support\Testing\Fakes\NotificationFake;

/**
 * @method static \Illuminate\Notifications\ChannelManager locale(string|null $locale)
 * @method static \BeyondSEODeps\Illuminate\Support\Collection sent(mixed $notifiable, string $notification, ?callable $callback = null)
 ...
 * @method static void send(\BeyondSEODeps\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 * @method static void sendNow(\BeyondSEODeps\Illuminate\Support\Collection|array|mixed $notifiables, $notification)
 *
...
class Notification extends Facade
{
     ...
     *
     * @return \BeyondSEODeps\Illuminate\Support\Testing\Fakes\NotificationFake
     */
