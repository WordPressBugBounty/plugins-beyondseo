...
use BeyondSEODeps\Illuminate\Support\Testing\Fakes\QueueFake;

/**
 * @method static \BeyondSEODeps\Illuminate\Contracts\Queue\Job|null pop(?string $queue = null)
 * @method static \BeyondSEODeps\Illuminate\Contracts\Queue\Queue setConnectionName(string $name)
...
class Queue extends Facade
{
     ...
     *
     * @return \BeyondSEODeps\Illuminate\Support\Testing\Fakes\QueueFake
     */
