...
class Stringable implements JsonSerializable
{
    ...
    {
        return new static(beondseodeps_class_basename($this->value));
    }
    ...
    {
        return beondseodeps_collect(explode($delimiter, $this->value, $limit));
    }
    ...
    public function split($pattern, $limit = -1, $flags = 0)
    {
        if (filter_var($pattern, FILTER_VALIDATE_INT) !== false) {
            return beondseodeps_collect(mb_str_split($this->value, $pattern));
        }

        $segments = preg_split($pattern, $this->value, $limit, $flags);

        return ! empty($segments) ? beondseodeps_collect($segments) : beondseodeps_collect();
    }
    ...
    {
        return beondseodeps_collect(sscanf($this->value, $format));
    }
    ...
    {
        return beondseodeps_collect(Str::ucsplit($this->value));
    }
