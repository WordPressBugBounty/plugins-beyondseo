...
class QueueFake extends QueueManager implements Queue
{
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return beondseodeps_collect($this->jobs[$job])->filter(function ($data) use ($callback) {
    ...
    {
        return beondseodeps_collect($this->jobs)->flatten(1)->filter(function ($job) use ($queue) {
     ...
     *
     * @param  string|null  $queue
     * @return \BeyondSEODeps\Illuminate\Contracts\Queue\Job|null
     */
