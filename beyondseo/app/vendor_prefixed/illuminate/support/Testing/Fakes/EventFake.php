...
class EventFake implements Dispatcher
{
     ...
     *
     * @param  \BeyondSEODeps\Illuminate\Contracts\Events\Dispatcher  $dispatcher
    ...
    public function dispatched($event, $callback = null)
    {
        ...
        return beondseodeps_collect($this->events[$event])->filter(function ($arguments) use ($callback) {
    ...
    protected function shouldFakeEvent($eventName, $payload)
    {
        ...
        return beondseodeps_collect($this->eventsToFake)
