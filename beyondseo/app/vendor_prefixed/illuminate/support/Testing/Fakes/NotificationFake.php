...
use Closure;
use Exception;
use BeyondSEODeps\Illuminate\Contracts\Notifications\Dispatcher as NotificationDispatcher;
use BeyondSEODeps\Illuminate\Contracts\Notifications\Factory as NotificationFactory;
use BeyondSEODeps\Illuminate\Contracts\Translation\HasLocalePreference;
...
class NotificationFake implements NotificationDispatcher, NotificationFactory
{
    ...
    {
        $actualCount = beondseodeps_collect($this->notifications)
            ->flatten(1)
    ...
    public function sent($notifiable, $notification, $callback = null)
    {
        ...
        $notifications = beondseodeps_collect($this->notificationsFor($notifiable, $notification));
    ...
    public function sendNow($notifiables, $notification, ?array $channels = null)
    {
        ...
        foreach ($notifiables as $notifiable) {
            ...
            $this->notifications[get_class($notifiable)][$notifiable->getKey()][get_class($notification)][] = [
                ...
                'locale' => $notification->locale ?? $this->locale ?? beondseodeps_value(function () use ($notifiable) {
