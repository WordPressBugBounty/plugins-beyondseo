...
use Closure;
use BeyondSEODeps\Illuminate\Support\Reflector;
...
trait ReflectsClosures
{
    ...
    protected function firstClosureParameterTypes(Closure $closure)
    {
        ...
        $types = beondseodeps_collect($reflection->getParameters())->mapWithKeys(function ($parameter) {
    ...
    protected function closureParameterTypes(Closure $closure)
    {
        ...
        return beondseodeps_collect($reflection->getParameters())->mapWithKeys(function ($parameter) {
            if ($parameter->isVariadic()) {
                return [$parameter->getName() => null];
            }
