...
use Closure;
use BeyondSEODeps\Illuminate\Bus\Events\BatchDispatched;
use BeyondSEODeps\Illuminate\Contracts\Container\Container;
use BeyondSEODeps\Illuminate\Contracts\Events\Dispatcher as EventDispatcher;
...
class PendingBatch
{
     ...
     *
     * @var \BeyondSEODeps\Illuminate\Support\Collection
     */
    public $jobs;
     ...
     * @param  \BeyondSEODeps\Illuminate\Support\Collection  $jobs
     * @return void
     */
