...
use BeyondSEODeps\Illuminate\Contracts\Broadcasting\Factory as BroadcastFactory;
use BeyondSEODeps\Illuminate\Contracts\Broadcasting\ShouldBroadcast;
use BeyondSEODeps\Illuminate\Contracts\Container\Container as ContainerContract;
use BeyondSEODeps\Illuminate\Contracts\Events\Dispatcher as DispatcherContract;
use BeyondSEODeps\Illuminate\Contracts\Queue\ShouldBeEncrypted;
use BeyondSEODeps\Illuminate\Contracts\Queue\ShouldQueue;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \BeyondSEODeps\Illuminate\Contracts\Container\Container|null  $container
     * @return void
     */
    ...
    public function listen($events, $listener = null)
    {
        if ($events instanceof Closure) {
            return beondseodeps_collect($this->firstClosureParameterTypes($events))
                ->each(function ($event) use ($events) {
                    $this->listen($event, $events);
                });
        } elseif ($events instanceof QueuedClosure) {
            return beondseodeps_collect($this->firstClosureParameterTypes($events->closure))
                ->each(function ($event) use ($events) {
     ...
     *
     * @param  \BeyondSEODeps\Illuminate\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
    ...
    {
        return beondseodeps_tap($job, function ($job) use ($listener) {
