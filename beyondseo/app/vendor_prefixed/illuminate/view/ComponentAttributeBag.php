...
use BeyondSEODeps\Illuminate\Support\HtmlString;
use BeyondSEODeps\Illuminate\Support\Str;
use BeyondSEODeps\Illuminate\Support\Traits\Conditionable;
...
class ComponentAttributeBag implements ArrayAccess, Htmlable, IteratorAggregate
{
    ...
    {
        return $this->getIterator()->current() ?? beondseodeps_value($default);
    }
    ...
    {
        return $this->attributes[$key] ?? beondseodeps_value($default);
    }
    ...
    {
        return new static(beondseodeps_collect($this->attributes)->filter($callback)->all());
    }
    ...
    public function merge(array $attributeDefaults = [], $escape = true)
    {
        $attributeDefaults = array_map(function ($value) use ($escape) {
            return $this->shouldEscapeAttributeValue($escape, $value)
                        ? beondseodeps_e($value)
                        : $value;
        }, $attributeDefaults);

        [$appendableAttributes, $nonAppendableAttributes] = beondseodeps_collect($this->attributes)
     ...
     *
     * @param  mixed  $value
     * @return \BeyondSEODeps\Illuminate\View\AppendableAttributeValue
     */
     ...
     *
     * @param  array  $attributeDefaults
     * @return \BeyondSEODeps\Illuminate\Support\HtmlString
     */
