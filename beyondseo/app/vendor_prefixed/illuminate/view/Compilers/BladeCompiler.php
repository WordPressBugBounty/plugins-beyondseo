...
namespace BeyondSEODeps\Illuminate\View\Compilers;

use BeyondSEODeps\Illuminate\Container\Container;
use BeyondSEODeps\Illuminate\Contracts\Support\Htmlable;
use BeyondSEODeps\Illuminate\Contracts\View\Factory as ViewFactory;
use BeyondSEODeps\Illuminate\Contracts\View\View;
use BeyondSEODeps\Illuminate\Support\Arr;
use BeyondSEODeps\Illuminate\Support\Str;
use BeyondSEODeps\Illuminate\Support\Traits\ReflectsClosures;
use BeyondSEODeps\Illuminate\View\Component;
use InvalidArgumentException;
class BladeCompiler extends Compiler implements CompilerInterface
{
    use \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesAuthorizations, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesClasses, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesComments, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesComponents, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesConditionals, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesEchos, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesErrors, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesHelpers, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesIncludes, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesInjections, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesJson, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesJs, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesLayouts, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesLoops, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesRawPhp, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesStacks, \BeyondSEODeps\Illuminate\View\Compilers\Concerns\CompilesTranslations, ReflectsClosures;
    /**
    ...
    {
        return beondseodeps_collect(token_get_all($contents))->pluck(0)->filter(function ($token) {
    ...
    public static function render($string, $data = [], $deleteCachedView = false)
    {
        ...
        return beondseodeps_tap($view->render(), function () use ($view, $deleteCachedView) {
            if ($deleteCachedView) {
                unlink($view->getPath());
            }
        });
     ...
     *
     * @param  \BeyondSEODeps\Illuminate\View\Component  $component
     * @return string
     */
    public static function renderComponent(Component $component)
    {
        $data = $component->data();
        $view = beondseodeps_value($component->resolveView(), $data);
    ...
    public function if($name, callable $callback)
    {
        ...
        $this->directive($name, function ($expression) use ($name) {
            return $expression !== '' ? "<?php if (\\BeyondSEODeps\\Illuminate\\Support\\Facades\\Blade::check('{$name}', {$expression})): ?>" : "<?php if (\\BeyondSEODeps\\Illuminate\\Support\\Facades\\Blade::check('{$name}')): ?>";
        });
        $this->directive('unless' . $name, function ($expression) use ($name) {
            return $expression !== '' ? "<?php if (! \\BeyondSEODeps\\Illuminate\\Support\\Facades\\Blade::check('{$name}', {$expression})): ?>" : "<?php if (! \\BeyondSEODeps\\Illuminate\\Support\\Facades\\Blade::check('{$name}')): ?>";
        });
        $this->directive('else' . $name, function ($expression) use ($name) {
            return $expression !== '' ? "<?php elseif (\\BeyondSEODeps\\Illuminate\\Support\\Facades\\Blade::check('{$name}', {$expression})): ?>" : "<?php elseif (\\BeyondSEODeps\\Illuminate\\Support\\Facades\\Blade::check('{$name}')): ?>";
        });
    ...
    public function component($class, $alias = null, $prefix = '')
    {
        ...
        if (is_null($alias)) {
            $alias = Str::contains($class, '\View\Components\\') ? beondseodeps_collect(explode('\\', Str::after($class, '\View\Components\\')))->map(function ($segment) {
                return Str::kebab($segment);
            })->implode(':') : Str::kebab(beondseodeps_class_basename($class));
        }
        if (!empty($prefix)) {
            $alias = $prefix . '-' . $alias;
        }
    ...
    public function aliasInclude($path, $alias = null)
    {
        ...
        $this->directive($alias, function ($expression) use ($path) {
            ...
            return "<?php echo \$__env->make('{$path}', {$expression}, \\BeyondSEODeps\\Illuminate\\Support\\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>";
        });
    }
    /**
