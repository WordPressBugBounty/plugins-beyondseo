...
trait ManagesLayouts
{
    ...
    public function startSection($section, $content = null)
    {
        if ($content === null) {
            ...
            $this->extendSection($section, $content instanceof View ? $content : beondseodeps_e($content));
        }
    }
    ...
    {
        $sectionContent = $default instanceof View ? $default : beondseodeps_e($default);
