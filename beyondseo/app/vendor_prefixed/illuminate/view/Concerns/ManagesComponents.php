...
namespace BeyondSEODeps\Illuminate\View\Concerns;
...
use BeyondSEODeps\Illuminate\View\ComponentSlot;
...
trait ManagesComponents
{
     ...
     *
     * @param  \BeyondSEODeps\Illuminate\Contracts\View\View|\BeyondSEODeps\Illuminate\Contracts\Support\Htmlable|\Closure|string  $view
     * @param  array  $data
     * @return void
     */
    ...
    public function renderComponent()
    {
        ...
        try {
            $view = beondseodeps_value($view, $data);
    ...
    {
        beondseodeps_last($this->componentStack);
