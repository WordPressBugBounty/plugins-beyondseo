...
use BeyondSEODeps\Illuminate\View\Compilers\ComponentTagCompiler;
...
class DynamicComponent extends Component
{
     ...
     *
     * @var \BeyondSEODeps\Illuminate\View\Compilers\BladeTagCompiler
     */
     ...
     *
     * @return \BeyondSEODeps\Illuminate\Contracts\View\View|string
     */
    public function render()
    {
        $template = <<<'EOF'
<?php extract(collect($attributes->getAttributes())->mapWithKeys(function ($value, $key) { return [BeyondSEODeps\Illuminate\Support\Str::camel(str_replace([':', '.'], ' ', $key)) => $value]; })->all(), EXTR_SKIP); ?>
{{ props }}
...
EOF;
    ...
    protected function compileProps(array $bindings)
    {
        ...
        return '@props('.'[\''.implode('\',\'', beondseodeps_collect($bindings)->map(function ($dataKey) {
    ...
    {
        return beondseodeps_collect($bindings)->map(function ($key) {
    ...
    {
        return beondseodeps_collect($slots)->map(function ($slot, $name) {
     ...
     *
     * @return \BeyondSEODeps\Illuminate\View\Compilers\ComponentTagCompiler
     */
