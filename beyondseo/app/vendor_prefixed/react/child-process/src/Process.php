...
namespace BeyondSEODeps\React\ChildProcess;

use BeyondSEODeps\Evenement\EventEmitter;
use BeyondSEODeps\React\EventLoop\Loop;
use BeyondSEODeps\React\EventLoop\LoopInterface;
use BeyondSEODeps\React\Stream\ReadableResourceStream;
use BeyondSEODeps\React\Stream\ReadableStreamInterface;
use BeyondSEODeps\React\Stream\WritableResourceStream;
use BeyondSEODeps\React\Stream\WritableStreamInterface;
use BeyondSEODeps\React\Stream\DuplexResourceStream;
use BeyondSEODeps\React\Stream\DuplexStreamInterface;
    ...
    */
    ...
    public function start($loop = null, $interval = 0.1)
    {
        if ($loop !== null && !$loop instanceof LoopInterface) { // manual type check to support legacy PHP < 7.1
            throw new \InvalidArgumentException('Argument #1 ($loop) expected null|BeyondSEODeps\React\EventLoop\LoopInterface');
        }
        if ($this->isRunning()) {
     ...
     *
     * @see \BeyondSEODeps\Symfony\Component\Process\Process::isSigchildEnabled()
     * @return bool
     */
