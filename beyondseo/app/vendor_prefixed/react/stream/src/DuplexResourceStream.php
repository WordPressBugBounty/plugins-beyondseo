...
namespace BeyondSEODeps\React\Stream;
...
final class DuplexResourceStream extends EventEmitter implements DuplexStreamInterface
{
    ...
    public function __construct($stream, $loop = null, $readChunkSize = null, $buffer = null)
    {
        ...
        if ($loop !== null && !$loop instanceof LoopInterface) {
            ...
            throw new \InvalidArgumentException('Argument #2 ($loop) expected null|BeyondSEODeps\React\EventLoop\LoopInterface');
        }
        if ($buffer !== null && !$buffer instanceof WritableStreamInterface) {
            // manual type check to support legacy PHP < 7.1
            throw new \InvalidArgumentException('Argument #4 ($buffer) expected null|BeyondSEODeps\React\Stream\WritableStreamInterface');
        }
