...
namespace BeyondSEODeps\JMS\Parser;
...
abstract class AbstractLexer
{
    ...
    /**
     * @return \BeyondSEODeps\PhpOption\Option<[string,integer,integer]>
     */
    public function peek()
    {
        if ( ! isset($this->tokens[$this->i + (++$this->peek)])) {
            return \BeyondSEODeps\PhpOption\None::create();
        }

        return new \BeyondSEODeps\PhpOption\Some($this->tokens[$this->i + $this->peek]);
    }
