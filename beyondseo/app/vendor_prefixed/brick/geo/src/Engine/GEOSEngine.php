...
use BeyondSEODeps\Brick\Geo\Exception\GeometryEngineException;
use BeyondSEODeps\Brick\Geo\IO\EWKBReader;
use BeyondSEODeps\Brick\Geo\IO\EWKBWriter;
...
use BeyondSEODeps\Brick\Geo\Surface;
