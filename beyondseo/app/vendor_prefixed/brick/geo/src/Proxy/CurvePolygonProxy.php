...
class CurvePolygonProxy extends CurvePolygon implements ProxyInterface
{
    ...
    public function exteriorRing(): \BeyondSEODeps\Brick\Geo\Curve
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function interiorRingN(int $n): \BeyondSEODeps\Brick\Geo\Curve
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function project(\BeyondSEODeps\Brick\Geo\Projector\Projector $projector): \BeyondSEODeps\Brick\Geo\CurvePolygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withExteriorRing(\BeyondSEODeps\Brick\Geo\Curve $exteriorRing): \BeyondSEODeps\Brick\Geo\CurvePolygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withInteriorRings(\BeyondSEODeps\Brick\Geo\Curve ...$interiorRings): \BeyondSEODeps\Brick\Geo\CurvePolygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withAddedInteriorRings(\BeyondSEODeps\Brick\Geo\Curve ...$interiorRings): \BeyondSEODeps\Brick\Geo\CurvePolygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
