...
use BeyondSEODeps\Brick\Geo\MultiCurve;
...
class MultiCurveProxy extends MultiCurve implements ProxyInterface
{
    ...
    public function project(\BeyondSEODeps\Brick\Geo\Projector\Projector $projector): \BeyondSEODeps\Brick\Geo\MultiCurve
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
