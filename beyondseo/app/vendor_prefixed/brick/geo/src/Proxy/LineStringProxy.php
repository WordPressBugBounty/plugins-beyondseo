...
class LineStringProxy extends LineString implements ProxyInterface
{
    ...
    public function project(\BeyondSEODeps\Brick\Geo\Projector\Projector $projector): \BeyondSEODeps\Brick\Geo\LineString
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withAddedPoints(\BeyondSEODeps\Brick\Geo\Point ...$points): \BeyondSEODeps\Brick\Geo\LineString
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
