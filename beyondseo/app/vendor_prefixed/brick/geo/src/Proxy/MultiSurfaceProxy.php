...
use BeyondSEODeps\Brick\Geo\MultiSurface;
...
class MultiSurfaceProxy extends MultiSurface implements ProxyInterface
{
    ...
    public function project(\BeyondSEODeps\Brick\Geo\Projector\Projector $projector): \BeyondSEODeps\Brick\Geo\MultiSurface
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function geometryN(int $n): \BeyondSEODeps\Brick\Geo\Geometry
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withAddedGeometries(\BeyondSEODeps\Brick\Geo\Geometry ...$geometries): \BeyondSEODeps\Brick\Geo\GeometryCollection
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
