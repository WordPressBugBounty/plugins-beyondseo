...
class TriangleProxy extends Triangle implements ProxyInterface
{
    ...
    public function project(\BeyondSEODeps\Brick\Geo\Projector\Projector $projector): \BeyondSEODeps\Brick\Geo\Triangle
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function exteriorRing(): \BeyondSEODeps\Brick\Geo\LineString
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function interiorRingN(int $n): \BeyondSEODeps\Brick\Geo\LineString
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withExteriorRing(\BeyondSEODeps\Brick\Geo\LineString $exteriorRing): \BeyondSEODeps\Brick\Geo\Polygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withInteriorRings(\BeyondSEODeps\Brick\Geo\LineString ...$interiorRings): \BeyondSEODeps\Brick\Geo\Polygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withAddedInteriorRings(\BeyondSEODeps\Brick\Geo\LineString ...$interiorRings): \BeyondSEODeps\Brick\Geo\Polygon
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
