...
class CircularStringProxy extends CircularString implements ProxyInterface
{
    ...
    public function startPoint(): \BeyondSEODeps\Brick\Geo\Point
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function endPoint(): \BeyondSEODeps\Brick\Geo\Point
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function pointN(int $n): \BeyondSEODeps\Brick\Geo\Point
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function project(\BeyondSEODeps\Brick\Geo\Projector\Projector $projector): \BeyondSEODeps\Brick\Geo\CircularString
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
    ...
    public function withAddedPoints(\BeyondSEODeps\Brick\Geo\Point ...$points): \BeyondSEODeps\Brick\Geo\CircularString
    {
        if ($this->proxyGeometry === null) {
            $this->load();
        }
