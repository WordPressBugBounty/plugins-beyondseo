...
namespace BeyondSEODeps\ProxyManager\ProxyGenerator\Util;
...
$scopeObject = isset($backtrace[1]['object']) ? $backtrace[1]['object'] : new \BeyondSEODeps\ProxyManager\Stub\EmptyClassStub();
