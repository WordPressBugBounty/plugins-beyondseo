...
use BeyondSEODeps\ProxyManager\ProxyGenerator\LazyLoadingGhostGenerator;
...
class LazyLoadingGhostFactory extends AbstractBaseFactory
{
     ...
     */
    public function createProxy(string $className, Closure $initializer, array $proxyOptions = []): GhostObjectInterface
    {
