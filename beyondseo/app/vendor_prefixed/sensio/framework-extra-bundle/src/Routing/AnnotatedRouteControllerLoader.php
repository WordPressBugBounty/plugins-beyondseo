...
namespace BeyondSEODeps\Sensio\Bundle\FrameworkExtraBundle\Routing;

use BeyondSEODeps\Sensio\Bundle\FrameworkExtraBundle\Configuration\Method;
use BeyondSEODeps\Sensio\Bundle\FrameworkExtraBundle\Configuration\Route as FrameworkExtraBundleRoute;
use BeyondSEODeps\Symfony\Component\Routing\Loader\AnnotationClassLoader;
use BeyondSEODeps\Symfony\Component\Routing\Route;

@trigger_error(sprintf('The "%s" class is deprecated since version 5.2. Use "%s" instead.', AnnotatedRouteControllerLoader::class, \BeyondSEODeps\Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader::class), \E_USER_DEPRECATED);
