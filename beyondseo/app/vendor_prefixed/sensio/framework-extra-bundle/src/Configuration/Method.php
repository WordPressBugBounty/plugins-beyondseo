...
namespace BeyondSEODeps\Sensio\Bundle\FrameworkExtraBundle\Configuration;

@trigger_error(sprintf('The "%s" annotation is deprecated since version 5.2. Use "%s" instead.', Method::class, \BeyondSEODeps\Symfony\Component\Routing\Annotation\Route::class), \E_USER_DEPRECATED);
