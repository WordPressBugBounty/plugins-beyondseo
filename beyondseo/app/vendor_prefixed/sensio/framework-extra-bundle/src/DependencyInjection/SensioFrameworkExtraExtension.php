...
namespace BeyondSEODeps\Sensio\Bundle\FrameworkExtraBundle\DependencyInjection;

use BeyondSEODeps\Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\ParamConverterInterface;
...
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\ExpressionLanguage as SecurityExpressionLanguage;
...
class SensioFrameworkExtraExtension extends Extension
{
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if ($config['router']['annotations']) {
            @trigger_error(sprintf('Enabling the "sensio_framework_extra.router.annotations" configuration is deprecated since version 5.2. Set it to false and use the "%s" annotation from Symfony itself.', \BeyondSEODeps\Symfony\Component\Routing\Annotation\Route::class), \E_USER_DEPRECATED);
