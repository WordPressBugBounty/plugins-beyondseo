 ...
 *
 *      $logger = new \BeyondSEODeps\Monolog\Logger('all', array(new \BeyondSEODeps\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['BeyondSEODeps\\Monolog\\'], // array Hide calls of classes started with...
