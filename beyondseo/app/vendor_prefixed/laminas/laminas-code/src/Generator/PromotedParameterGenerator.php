...
use BeyondSEODeps\Laminas\Code\Reflection\Exception\RuntimeException;
use BeyondSEODeps\Laminas\Code\Reflection\ParameterReflection;
...
final class PromotedParameterGenerator extends ParameterGenerator
{
    ...
    public static function fromParameterGeneratorWithVisibility(ParameterGenerator $generator, string $visibility): self
    {
        ...
        if ('' === $name) {
            throw new \BeyondSEODeps\Laminas\Code\Generator\Exception\RuntimeException(
