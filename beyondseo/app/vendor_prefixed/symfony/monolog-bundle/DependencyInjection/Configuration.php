    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $handlerNode
            ->children()
                ...
                ->scalarNode('bot_name')->defaultValue('BeyondSEODeps\Monolog')->end() // slack & slackwebhook
                ...
                ->scalarNode('nickname')->defaultValue('BeyondSEODeps\Monolog')->end() // hipchat
                ...
                ->arrayNode('verbosity_levels') // console
                    ...
                    ->validate()
                        ->always(function ($v) {
                            $map = [];
                            foreach ($v as $verbosity => $level) {
                                $verbosityConstant = 'BeyondSEODeps\Symfony\Component\Console\Output\OutputInterface::'.$verbosity;
