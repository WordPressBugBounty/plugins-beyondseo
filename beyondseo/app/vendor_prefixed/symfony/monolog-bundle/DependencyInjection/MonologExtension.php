...
namespace BeyondSEODeps\Symfony\Bundle\MonologBundle\DependencyInjection;

use BeyondSEODeps\Monolog\Attribute\AsMonologProcessor;
use BeyondSEODeps\Monolog\Attribute\WithMonologChannel;
use BeyondSEODeps\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use BeyondSEODeps\Monolog\Handler\HandlerInterface;
use BeyondSEODeps\Monolog\Logger;
use BeyondSEODeps\Monolog\Processor\ProcessorInterface;
use BeyondSEODeps\Monolog\Processor\PsrLogMessageProcessor;
use BeyondSEODeps\Monolog\ResettableInterface;
use BeyondSEODeps\Symfony\Bridge\Monolog\Handler\FingersCrossed\HttpCodeActivationStrategy;
use BeyondSEODeps\Symfony\Bridge\Monolog\Processor\SwitchUserTokenProcessor;
use BeyondSEODeps\Symfony\Bridge\Monolog\Processor\TokenProcessor;
use BeyondSEODeps\Symfony\Bridge\Monolog\Processor\WebProcessor;
use BeyondSEODeps\Symfony\Bridge\Monolog\Logger as LegacyLogger;
use Symfony\Bundle\FullStack;
use BeyondSEODeps\Symfony\Component\Config\FileLocator;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\BoundArgument;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
...
use BeyondSEODeps\Symfony\Component\HttpKernel\Log\DebugLoggerConfigurator;
...
class MonologExtension extends Extension
{
    ...
    private function buildHandler(ContainerBuilder $container, $name, array $handler)
    {
        ...
        if ($handler['include_stacktraces']) {
            $definition->setConfigurator(['BeyondSEODeps\\Symfony\\Bundle\\MonologBundle\\MonologBundle', 'includeStacktraces']);
        }
        ...
        case 'telegram':
            if (!class_exists('BeyondSEODeps\Monolog\Handler\TelegramBotHandler')) {
        ...
        case 'fingers_crossed':
            ...
            if (isset($handler['activation_strategy'])) {
                ...
                $activationDef = new Definition('BeyondSEODeps\Symfony\Bridge\Monolog\Handler\FingersCrossed\NotFoundActivationStrategy', [
                ...
                $activationDef = new Definition('BeyondSEODeps\Symfony\Bridge\Monolog\Handler\FingersCrossed\HttpCodeActivationStrategy', [
                    new Reference('request_stack'),
        ...
        case 'swift_mailer':
            ...
            if (isset($handler['email_prototype'])) {
                ...
                $messageFactory = new Definition('BeyondSEODeps\Symfony\Bundle\MonologBundle\SwiftMailer\MessageFactory');
        ...
        case 'flowdock':
            ...
            if (empty($handler['formatter'])) {
                $formatter = new Definition("BeyondSEODeps\Monolog\Formatter\FlowdockFormatter", [
                    $handler['source'],
                    $handler['from_email'],
                ]);
    ...
    {
        $typeToClassMapping = [
            'stream' => 'BeyondSEODeps\Monolog\Handler\StreamHandler',
            'console' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\ConsoleHandler',
            'group' => 'BeyondSEODeps\Monolog\Handler\GroupHandler',
            'buffer' => 'BeyondSEODeps\Monolog\Handler\BufferHandler',
            'deduplication' => 'BeyondSEODeps\Monolog\Handler\DeduplicationHandler',
            'rotating_file' => 'BeyondSEODeps\Monolog\Handler\RotatingFileHandler',
            'syslog' => 'BeyondSEODeps\Monolog\Handler\SyslogHandler',
            'syslogudp' => 'BeyondSEODeps\Monolog\Handler\SyslogUdpHandler',
            'null' => 'BeyondSEODeps\Monolog\Handler\NullHandler',
            'test' => 'BeyondSEODeps\Monolog\Handler\TestHandler',
            'gelf' => 'BeyondSEODeps\Monolog\Handler\GelfHandler',
            'rollbar' => 'BeyondSEODeps\Monolog\Handler\RollbarHandler',
            'flowdock' => 'BeyondSEODeps\Monolog\Handler\FlowdockHandler',
            'browser_console' => 'BeyondSEODeps\Monolog\Handler\BrowserConsoleHandler',
            'firephp' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\FirePHPHandler',
            'chromephp' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\ChromePhpHandler',
            'debug' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\DebugHandler',
            'swift_mailer' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\SwiftMailerHandler',
            'native_mailer' => 'BeyondSEODeps\Monolog\Handler\NativeMailerHandler',
            'symfony_mailer' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\MailerHandler',
            'socket' => 'BeyondSEODeps\Monolog\Handler\SocketHandler',
            'pushover' => 'BeyondSEODeps\Monolog\Handler\PushoverHandler',
            'raven' => 'BeyondSEODeps\Monolog\Handler\RavenHandler',
            'sentry' => 'Sentry\Monolog\Handler',
            'BeyondSEODeps\newrelic' => 'BeyondSEODeps\Monolog\Handler\NewRelicHandler',
            'hipchat' => 'BeyondSEODeps\Monolog\Handler\HipChatHandler',
            'slack' => 'BeyondSEODeps\Monolog\Handler\SlackHandler',
            'slackwebhook' => 'BeyondSEODeps\Monolog\Handler\SlackWebhookHandler',
            'slackbot' => 'BeyondSEODeps\Monolog\Handler\SlackbotHandler',
            'cube' => 'BeyondSEODeps\Monolog\Handler\CubeHandler',
            'amqp' => 'BeyondSEODeps\Monolog\Handler\AmqpHandler',
            'error_log' => 'BeyondSEODeps\Monolog\Handler\ErrorLogHandler',
            'loggly' => 'BeyondSEODeps\Monolog\Handler\LogglyHandler',
            'logentries' => 'BeyondSEODeps\Monolog\Handler\LogEntriesHandler',
            'whatfailuregroup' => 'BeyondSEODeps\Monolog\Handler\WhatFailureGroupHandler',
            'fingers_crossed' => 'BeyondSEODeps\Monolog\Handler\FingersCrossedHandler',
            'filter' => 'BeyondSEODeps\Monolog\Handler\FilterHandler',
            'mongo' => 'BeyondSEODeps\Monolog\Handler\MongoDBHandler',
            'elasticsearch' => 'BeyondSEODeps\Monolog\Handler\ElasticSearchHandler',
            'telegram' => 'BeyondSEODeps\Monolog\Handler\TelegramBotHandler',
            'server_log' => 'BeyondSEODeps\Symfony\Bridge\Monolog\Handler\ServerLogHandler',
            'redis' => 'BeyondSEODeps\Monolog\Handler\RedisHandler',
            'predis' => 'BeyondSEODeps\Monolog\Handler\RedisHandler',
            'insightops' => 'BeyondSEODeps\Monolog\Handler\InsightOpsHandler',
            'sampling' => 'BeyondSEODeps\Monolog\Handler\SamplingHandler',
        ];

        $v2HandlerTypesAdded = [
            'elastica' => 'BeyondSEODeps\Monolog\Handler\ElasticaHandler',
            'elasticsearch' => 'BeyondSEODeps\Monolog\Handler\ElasticaHandler',
            'elastic_search' => 'BeyondSEODeps\Monolog\Handler\ElasticsearchHandler',
            'fallbackgroup' => 'BeyondSEODeps\Monolog\Handler\FallbackGroupHandler',
            'noop' => 'BeyondSEODeps\Monolog\Handler\NoopHandler',
        ];
