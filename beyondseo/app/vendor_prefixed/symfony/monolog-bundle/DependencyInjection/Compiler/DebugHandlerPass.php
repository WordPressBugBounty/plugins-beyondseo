...
namespace BeyondSEODeps\Symfony\Bundle\MonologBundle\DependencyInjection\Compiler;
...
class DebugHandlerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container)
    {
        ...
        $debugHandler = new Definition('BeyondSEODeps\Symfony\Bridge\Monolog\Handler\DebugHandler', [Logger::DEBUG, true]);
