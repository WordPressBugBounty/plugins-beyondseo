...
use BeyondSEODeps\GuzzleHttp\Promise\Promise as GuzzlePromise;
use BeyondSEODeps\GuzzleHttp\Promise\RejectedPromise;
use BeyondSEODeps\GuzzleHttp\Promise\Utils;
...
use BeyondSEODeps\Symfony\Component\HttpClient\Internal\HttplugWaitLoop;
use BeyondSEODeps\Symfony\Component\HttpClient\Response\HttplugPromise;
...
if (!interface_exists(HttplugInterface::class)) {
    throw new \LogicException('You cannot use "BeyondSEODeps\Symfony\Component\HttpClient\HttplugClient" as the "php-http/httplug" package is not installed. Try running "composer require php-http/httplug".');
}

if (!interface_exists(RequestFactory::class)) {
    throw new \LogicException('You cannot use "BeyondSEODeps\Symfony\Component\HttpClient\HttplugClient" as the "php-http/message-factory" package is not installed. Try running "composer require nyholm/psr7".');
}
    ...
    public function __construct(?HttpClientInterface $client = null, ?ResponseFactoryInterface $responseFactory = null, ?StreamFactoryInterface $streamFactory = null)
    {
        ...
        if (null === $responseFactory || null === $streamFactory) {
            if (!class_exists(Psr17Factory::class) && !class_exists(Psr17FactoryDiscovery::class)) {
                throw new \LogicException('You cannot use the "BeyondSEODeps\Symfony\Component\HttpClient\HttplugClient" as no PSR-17 factories have been provided. Try running "composer require nyholm/psr7".');
            }
            ...
            try {
                ...
                throw new \LogicException('You cannot use the "BeyondSEODeps\Symfony\Component\HttpClient\HttplugClient" as no PSR-17 factories have been found. Try running "composer require nyholm/psr7".', 0, $e);
            }
        }
