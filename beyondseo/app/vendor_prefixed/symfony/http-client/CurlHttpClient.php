...
use BeyondSEODeps\Symfony\Component\HttpClient\Internal\CurlClientState;
use BeyondSEODeps\Symfony\Component\HttpClient\Internal\PushedResponse;
use BeyondSEODeps\Symfony\Component\HttpClient\Response\CurlResponse;
...
final class CurlHttpClient implements HttpClientInterface, LoggerAwareInterface, ResetInterface
{
    ...
    public function __construct(array $defaultOptions = [], int $maxHostConnections = 6, int $maxPendingPushes = 50)
    {
        if (!\extension_loaded('curl')) {
            throw new \LogicException('You cannot use the "BeyondSEODeps\Symfony\Component\HttpClient\CurlHttpClient" as the "curl" extension is not installed.');
        }
