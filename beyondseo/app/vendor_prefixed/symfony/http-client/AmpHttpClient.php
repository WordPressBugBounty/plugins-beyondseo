...
use BeyondSEODeps\Symfony\Component\HttpClient\Exception\TransportException;
use BeyondSEODeps\Symfony\Component\HttpClient\Internal\AmpClientState;
use BeyondSEODeps\Symfony\Component\HttpClient\Response\AmpResponse;
...
if (!interface_exists(DelegateHttpClient::class)) {
    throw new \LogicException('You cannot use "BeyondSEODeps\Symfony\Component\HttpClient\AmpHttpClient" as the "amphp/http-client" package is not installed. Try running "composer require amphp/http-client:^4.2.1".');
}

if (!interface_exists(Promise::class)) {
    throw new \LogicException('You cannot use "BeyondSEODeps\Symfony\Component\HttpClient\AmpHttpClient" as the installed "amphp/http-client" is not compatible with this version of "symfony/http-client". Try downgrading "amphp/http-client" to "^4.2.1".');
}
