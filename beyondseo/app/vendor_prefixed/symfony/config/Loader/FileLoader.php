...
namespace BeyondSEODeps\Symfony\Component\Config\Loader;

use BeyondSEODeps\Symfony\Component\Config\Exception\FileLoaderImportCircularReferenceException;
use BeyondSEODeps\Symfony\Component\Config\Exception\FileLocatorFileNotFoundException;
use BeyondSEODeps\Symfony\Component\Config\Exception\LoaderLoadException;
...
abstract class FileLoader extends Loader
{
     ...
     * @internal
     */
    protected function glob(string $pattern, bool $recursive, array|GlobResource|null &$resource = null, bool $ignoreErrors = false, bool $forExclusion = false, array $excluded = [])
    {
