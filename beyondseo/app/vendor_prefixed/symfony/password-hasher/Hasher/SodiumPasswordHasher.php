...
use BeyondSEODeps\Symfony\Component\PasswordHasher\Exception\InvalidPasswordException;
use BeyondSEODeps\Symfony\Component\PasswordHasher\Exception\LogicException;
...
final class SodiumPasswordHasher implements PasswordHasherInterface
{
    ...
    public function hash(string $plainPassword): string
    {
        ...
        if (\extension_loaded('libsodium')) {
            return \BeyondSEODeps\Sodium\crypto_pwhash_str($plainPassword, $this->opsLimit, $this->memLimit);
        }
        throw new LogicException('Libsodium is not available. You should either install the sodium extension or use a different password hasher.');
    }
    public function verify(string $hashedPassword, string $plainPassword): bool
    {
        ...
        if (0 !== strpos($hashedPassword, '$argon')) {
            if (0 === strpos($hashedPassword, '$2') && (72 < \strlen($plainPassword) || false !== strpos($plainPassword, "\x00"))) {
        ...
        if (\extension_loaded('libsodium')) {
            return \BeyondSEODeps\Sodium\crypto_pwhash_str_verify($hashedPassword, $plainPassword);
        }
        return false;
    }
    public function needsRehash(string $hashedPassword): bool
    {
        ...
        if (\extension_loaded('libsodium')) {
            return \BeyondSEODeps\Sodium\crypto_pwhash_str_needs_rehash($hashedPassword, $this->opsLimit, $this->memLimit);
        }
        throw new LogicException('Libsodium is not available. You should either install the sodium extension or use a different password hasher.');
    }
}
