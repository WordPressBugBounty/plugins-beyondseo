...
use BeyondSEODeps\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface;
...
use BeyondSEODeps\Symfony\Component\HttpKernel\Controller\ArgumentResolverInterface;
use BeyondSEODeps\Symfony\Component\HttpKernel\Controller\ControllerResolverInterface;
use BeyondSEODeps\Symfony\Component\HttpKernel\Event\ControllerArgumentsEvent;
use BeyondSEODeps\Symfony\Component\HttpKernel\Event\ControllerEvent;
...
use BeyondSEODeps\Symfony\Component\HttpKernel\Event\TerminateEvent;
use BeyondSEODeps\Symfony\Component\HttpKernel\Event\ViewEvent;
use BeyondSEODeps\Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use BeyondSEODeps\Symfony\Component\HttpKernel\Exception\ControllerDoesNotReturnResponseException;
use BeyondSEODeps\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface;
use BeyondSEODeps\Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
    ...
    private function handleRaw(Request $request, int $type = self::MAIN_REQUEST): Response
    {
        ...
        if (!$response instanceof Response) {
            ...
            if ($event->hasResponse()) {
                ...
                $msg = sprintf('The controller must return a "BeyondSEODeps\Symfony\Component\HttpFoundation\Response" object but it returned %s.', $this->varToString($response));
