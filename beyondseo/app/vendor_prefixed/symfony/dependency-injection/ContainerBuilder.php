...
namespace BeyondSEODeps\Symfony\Component\DependencyInjection;

use BeyondSEODeps\Composer\InstalledVersions;
use BeyondSEODeps\Symfony\Component\Config\Resource\ClassExistenceResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\ComposerResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\DirectoryResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\FileExistenceResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\FileResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\GlobResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\ReflectionClassResource;
use BeyondSEODeps\Symfony\Component\Config\Resource\ResourceInterface;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\AbstractArgument;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\RewindableGenerator;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\ServiceLocator;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Argument\ServiceLocatorArgument;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Attribute\Target;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Compiler\Compiler;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\Exception\RuntimeException;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use BeyondSEODeps\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use BeyondSEODeps\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use BeyondSEODeps\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use BeyondSEODeps\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
use BeyondSEODeps\Symfony\Component\ExpressionLanguage\Expression;
use BeyondSEODeps\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    private function doGet(string $id, int $invalidBehavior = ContainerInterface::EXCEPTION_ON_INVALID_REFERENCE, ?array &$inlineServices = null, bool $isConstructorArgument = false): mixed
    {
        ...
        if (!isset($this->definitions[$id]) && isset($this->aliasDefinitions[$id])) {
            ...
            if ($alias->isDeprecated()) {
                ...
                beondseodeps_trigger_deprecation($deprecation['package'], $deprecation['version'], $deprecation['message']);
            }
        ...
        if (null !== $factory) {
            ...
            if (!$definition->isDeprecated() && \is_array($factory) && \is_string($factory[0])) {
                ...
                if (0 < strpos($r->getDocComment(), "\n * @deprecated ")) {
                    beondseodeps_trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" factory class. It should either be deprecated or its factory upgraded.', $id, $r->name);
                }
            }
        } else {
            ...
            if (!$definition->isDeprecated() && 0 < strpos($r->getDocComment(), "\n * @deprecated ")) {
                beondseodeps_trigger_deprecation('', '', 'The "%s" service relies on the deprecated "%s" class. It should either be deprecated or its implementation upgraded.', $id, $r->name);
            }
        }
    ...
    private function getExpressionLanguage(): ExpressionLanguage
    {
        if (!isset($this->expressionLanguage)) {
            if (!class_exists(\BeyondSEODeps\Symfony\Component\ExpressionLanguage\ExpressionLanguage::class)) {
