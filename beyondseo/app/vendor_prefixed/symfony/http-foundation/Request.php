 ...
 */
namespace BeyondSEODeps\Symfony\Component\HttpFoundation;

use BeyondSEODeps\Symfony\Component\HttpFoundation\Exception\ConflictingHeadersException;
use BeyondSEODeps\Symfony\Component\HttpFoundation\Exception\JsonException;
use BeyondSEODeps\Symfony\Component\HttpFoundation\Exception\SessionNotFoundException;
use BeyondSEODeps\Symfony\Component\HttpFoundation\Exception\SuspiciousOperationException;
use BeyondSEODeps\Symfony\Component\HttpFoundation\Session\SessionInterface;
...
class Request
{
     ...
     * when trusted proxies were set via "setTrustedProxies()".
     *
     * The "X-Forwarded-Proto" header must contain the protocol: "https" or "BeyondSEODeps\http".
     */
