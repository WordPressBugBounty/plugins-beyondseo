...
use BeyondSEODeps\Symfony\Component\HttpKernel\RebootableInterface;
...
EOF
    ...
    private function warmup(string $warmupDir, string $realBuildDir, bool $enableOptionalWarmers = true)
    {
        ...
        if (!$kernel instanceof RebootableInterface) {
            throw new \LogicException('Calling "cache:clear" with a kernel that does not implement "BeyondSEODeps\Symfony\Component\HttpKernel\RebootableInterface" is not supported.');
        }
