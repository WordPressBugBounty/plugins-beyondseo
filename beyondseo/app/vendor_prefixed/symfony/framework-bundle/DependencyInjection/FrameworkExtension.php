...
namespace BeyondSEODeps\Symfony\Bundle\FrameworkBundle\DependencyInjection;

use BeyondSEODeps\Doctrine\Common\Annotations\AnnotationRegistry;
use BeyondSEODeps\Doctrine\Common\Annotations\Reader;
...
use BeyondSEODeps\Symfony\Bridge\Monolog\Processor\DebugProcessor;
use Symfony\Bridge\Twig\Extension\CsrfExtension;
use BeyondSEODeps\Symfony\Bundle\FrameworkBundle\Controller\AbstractController;
use BeyondSEODeps\Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader;
use BeyondSEODeps\Symfony\Bundle\FrameworkBundle\Routing\RouteLoaderInterface;
use Symfony\Bundle\FullStack;
use Symfony\Bundle\MercureBundle\MercureBundle;
use Symfony\Component\Asset\PackageInterface;
use Symfony\Component\BrowserKit\AbstractBrowser;
use BeyondSEODeps\Symfony\Component\Cache\Adapter\AdapterInterface;
...
use BeyondSEODeps\Symfony\Component\Cache\Adapter\TagAwareAdapter;
...
use BeyondSEODeps\Symfony\Component\Cache\ResettableInterface;
use BeyondSEODeps\Symfony\Component\Config\Definition\ConfigurationInterface;
use BeyondSEODeps\Symfony\Component\Config\FileLocator;
use BeyondSEODeps\Symfony\Component\Config\Loader\LoaderInterface;
use BeyondSEODeps\Symfony\Component\Config\Resource\DirectoryResource;
use BeyondSEODeps\Symfony\Component\Config\ResourceCheckerInterface;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\EnvVarLoaderInterface;
use BeyondSEODeps\Symfony\Component\DependencyInjection\EnvVarProcessorInterface;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\Parameter;
...
use BeyondSEODeps\Symfony\Component\Dotenv\Command\DebugCommand;
...
use BeyondSEODeps\Symfony\Component\Finder\Finder;
use Symfony\Component\Form\ChoiceList\Factory\CachingFactoryDecorator;
use Symfony\Component\Form\Form;
use Symfony\Component\Form\FormTypeExtensionInterface;
use Symfony\Component\Form\FormTypeGuesserInterface;
use Symfony\Component\Form\FormTypeInterface;
use BeyondSEODeps\Symfony\Component\HttpClient\MockHttpClient;
use BeyondSEODeps\Symfony\Component\HttpClient\Retry\GenericRetryStrategy;
use BeyondSEODeps\Symfony\Component\HttpClient\RetryableHttpClient;
use BeyondSEODeps\Symfony\Component\HttpClient\ScopingHttpClient;
use BeyondSEODeps\Symfony\Component\HttpFoundation\Request;
use BeyondSEODeps\Symfony\Component\HttpKernel\Attribute\AsController;
use BeyondSEODeps\Symfony\Component\HttpKernel\CacheClearer\CacheClearerInterface;
...
use BeyondSEODeps\Symfony\Component\HttpKernel\DataCollector\DataCollectorInterface;
use BeyondSEODeps\Symfony\Component\HttpKernel\DependencyInjection\Extension;
...
use BeyondSEODeps\Symfony\Component\Messenger\Attribute\AsMessageHandler;
use BeyondSEODeps\Symfony\Component\Messenger\Bridge\AmazonSqs\Transport\AmazonSqsTransportFactory;
use BeyondSEODeps\Symfony\Component\Messenger\Bridge\Amqp\Transport\AmqpTransportFactory;
use BeyondSEODeps\Symfony\Component\Messenger\Bridge\Beanstalkd\Transport\BeanstalkdTransportFactory;
use BeyondSEODeps\Symfony\Component\Messenger\Bridge\Redis\Transport\RedisTransportFactory;
use BeyondSEODeps\Symfony\Component\Messenger\Handler\BatchHandlerInterface;
use BeyondSEODeps\Symfony\Component\Messenger\Handler\MessageHandlerInterface;
use BeyondSEODeps\Symfony\Component\Messenger\MessageBus;
use BeyondSEODeps\Symfony\Component\Messenger\MessageBusInterface;
use BeyondSEODeps\Symfony\Component\Messenger\Middleware\RouterContextMiddleware;
use BeyondSEODeps\Symfony\Component\Messenger\Transport\Serialization\SerializerInterface;
use BeyondSEODeps\Symfony\Component\Messenger\Transport\TransportFactoryInterface;
use BeyondSEODeps\Symfony\Component\Messenger\Transport\TransportInterface;
...
use BeyondSEODeps\Symfony\Component\PropertyAccess\PropertyAccessor;
use BeyondSEODeps\Symfony\Component\PropertyInfo\Extractor\PhpStanExtractor;
...
use BeyondSEODeps\Symfony\Component\Routing\Loader\AnnotationDirectoryLoader;
...
use BeyondSEODeps\Symfony\Component\Validator\ConstraintValidatorInterface;
...
use BeyondSEODeps\Symfony\Component\Workflow;
use BeyondSEODeps\Symfony\Component\Workflow\WorkflowInterface;
use BeyondSEODeps\Symfony\Component\Yaml\Command\LintCommand as BaseYamlLintCommand;
use BeyondSEODeps\Symfony\Component\Yaml\Yaml;
use BeyondSEODeps\Symfony\Contracts\Cache\CacheInterface;
use BeyondSEODeps\Symfony\Contracts\Cache\CallbackInterface;
use BeyondSEODeps\Symfony\Contracts\Cache\TagAwareCacheInterface;
...
use BeyondSEODeps\Symfony\Contracts\Service\ResetInterface;
use BeyondSEODeps\Symfony\Contracts\Service\ServiceSubscriberInterface;
use BeyondSEODeps\Symfony\Contracts\Translation\LocaleAwareInterface;
...
class FrameworkExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        if (!ContainerBuilder::willBeAvailable('symfony/string', SluggerInterface::class, ['symfony/framework-bundle'])) {
            ...
            if (!\extension_loaded('intl') && !\defined('PHPUNIT_COMPOSER_INSTALL')) {
                beondseodeps_trigger_deprecation('', '', 'Please install the "intl" PHP extension for best performance.');
            }
        }
        ...
        if ($this->isConfigEnabled($container, $config['serializer'])) {
            if (!class_exists(\BeyondSEODeps\Symfony\Component\Serializer\Serializer::class)) {
        ...
        if ($this->messengerConfigEnabled = $this->isConfigEnabled($container, $config['messenger'])) {
            ...
            if ($container->hasDefinition('messenger.transport.amqp.factory') && !class_exists(AmqpTransportFactory::class)) {
                if (class_exists(\BeyondSEODeps\Symfony\Component\Messenger\Transport\AmqpExt\AmqpTransportFactory::class)) {
                    $container->getDefinition('messenger.transport.amqp.factory')
                        ->setClass(\BeyondSEODeps\Symfony\Component\Messenger\Transport\AmqpExt\AmqpTransportFactory::class)
            ...
            if ($container->hasDefinition('messenger.transport.redis.factory') && !class_exists(RedisTransportFactory::class)) {
                if (class_exists(\BeyondSEODeps\Symfony\Component\Messenger\Transport\RedisExt\RedisTransportFactory::class)) {
                    $container->getDefinition('messenger.transport.redis.factory')
                        ->setClass(\BeyondSEODeps\Symfony\Component\Messenger\Transport\RedisExt\RedisTransportFactory::class)
                        ->addTag('messenger.transport_factory');
                } else {
        ...
        $this->addAnnotatedClassesToCompile([
            ...
            'BeyondSEODeps\\Symfony\\Bundle\\FrameworkBundle\\Controller\\AbstractController',
        ]);
    ...
    private function registerAnnotationsConfiguration(array $config, ContainerBuilder $container, LoaderInterface $loader)
    {
        ...
        if (!class_exists(\BeyondSEODeps\Doctrine\Common\Annotations\Annotation::class)) {
    ...
    private function registerSecurityCsrfConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader)
    {
        ...
        if (!class_exists(\BeyondSEODeps\Symfony\Component\Security\Csrf\CsrfToken::class)) {
    ...
    private function registerSerializerConfiguration(array $config, ContainerBuilder $container, PhpFileLoader $loader)
    {
        ...
        if (isset($config['enable_annotations']) && $config['enable_annotations']) {
            $annotationLoader = new Definition(
                'BeyondSEODeps\Symfony\Component\Serializer\Mapping\Loader\AnnotationLoader',
                [new Reference('annotation_reader', ContainerInterface::NULL_ON_INVALID_REFERENCE)]
            );
        ...
        $fileRecorder = function ($extension, $path) use (&$serializerLoaders) {
            $definition = new Definition(\in_array($extension, ['yaml', 'yml']) ? 'BeyondSEODeps\Symfony\Component\Serializer\Mapping\Loader\YamlFileLoader' : 'BeyondSEODeps\Symfony\Component\Serializer\Mapping\Loader\XmlFileLoader', [$path]);
            $definition->setPublic(false);
    ...
    private function registerPropertyInfoConfiguration(ContainerBuilder $container, PhpFileLoader $loader)
    {
        ...
        if (ContainerBuilder::willBeAvailable('phpdocumentor/reflection-docblock', DocBlockFactoryInterface::class, ['symfony/framework-bundle', 'symfony/property-info'], true)) {
            $definition = $container->register('property_info.php_doc_extractor', 'BeyondSEODeps\Symfony\Component\PropertyInfo\Extractor\PhpDocExtractor');
