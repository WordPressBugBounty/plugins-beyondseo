...
use BeyondSEODeps\Symfony\Component\HttpFoundation\File\File;
...
{
    private const SUPPORTED_TYPES = [\SplFileInfo::class => true, \SplFileObject::class => true, File::class => true];
    /**
    ...
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): \SplFileInfo
    {
        ...
        throw new InvalidArgumentException(sprintf('The class parameter "%s" is not supported. It must be one of "SplFileInfo", "SplFileObject" or "BeyondSEODeps\Symfony\Component\HttpFoundation\File\File".', $type));
    }
    /**
     * {@inheritdoc}
     */
