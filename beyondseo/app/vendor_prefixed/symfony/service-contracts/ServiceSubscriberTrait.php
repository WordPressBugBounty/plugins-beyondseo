...
namespace BeyondSEODeps\Symfony\Contracts\Service;

use Psr\Container\ContainerInterface;
use BeyondSEODeps\Symfony\Contracts\Service\Attribute\Required;
use BeyondSEODeps\Symfony\Contracts\Service\Attribute\SubscribedService;

beondseodeps_trigger_deprecation('symfony/contracts', 'v3.5', '"%s" is deprecated, use "ServiceMethodsSubscriberTrait" instead.', ServiceSubscriberTrait::class);
