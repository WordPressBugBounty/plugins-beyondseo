...
namespace BeyondSEODeps\Symfony\Component\String;

use BeyondSEODeps\Symfony\Component\String\Exception\ExceptionInterface;
use BeyondSEODeps\Symfony\Component\String\Exception\InvalidArgumentException;
use BeyondSEODeps\Symfony\Component\String\Exception\RuntimeException;
...
abstract class AbstractUnicodeString extends AbstractString
{
    ...
    private const UPPER_TO = ['SS', 'FF', 'FI', 'FL', 'BeyondSEODeps\FFI', 'FFL', 'ST', 'ST', 'ԵՒ', 'ՄՆ', 'ՄԵ', 'ՄԻ', 'ՎՆ', 'ՄԽ', 'ʼN', 'Ϊ́', 'Ϋ́', 'J̌', 'H̱', 'T̈', 'W̊', 'Y̊', 'Aʾ', 'Υ̓', 'Υ̓̀', 'Υ̓́', 'Υ̓͂', 'Α͂', 'Η͂', 'Ϊ̀', 'Ϊ́', 'Ι͂', 'Ϊ͂', 'Ϋ̀', 'Ϋ́', 'Ρ̓', 'Υ͂', 'Ϋ͂', 'Ω͂'];
