...
namespace BeyondSEODeps\Symfony\Component\String\Slugger;

use BeyondSEODeps\Symfony\Component\String\AbstractUnicodeString;
use BeyondSEODeps\Symfony\Component\String\UnicodeString;
use BeyondSEODeps\Symfony\Contracts\Translation\LocaleAwareInterface;

if (!interface_exists(LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "BeyondSEODeps\Symfony\Component\String\Slugger\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
