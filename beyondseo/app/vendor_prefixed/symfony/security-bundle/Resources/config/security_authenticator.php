...
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\Security\UserAuthenticator;
use BeyondSEODeps\Symfony\Component\DependencyInjection\ServiceLocator;
use BeyondSEODeps\Symfony\Component\Security\Http\Authentication\AuthenticatorManager;
use BeyondSEODeps\Symfony\Component\Security\Http\Authentication\UserAuthenticatorInterface;
use BeyondSEODeps\Symfony\Component\Security\Http\Authenticator\FormLoginAuthenticator;
use BeyondSEODeps\Symfony\Component\Security\Http\Authenticator\HttpBasicAuthenticator;
use BeyondSEODeps\Symfony\Component\Security\Http\Authenticator\JsonLoginAuthenticator;
use BeyondSEODeps\Symfony\Component\Security\Http\Authenticator\RemoteUserAuthenticator;
use BeyondSEODeps\Symfony\Component\Security\Http\Authenticator\X509Authenticator;
use BeyondSEODeps\Symfony\Component\Security\Http\Event\CheckPassportEvent;
use BeyondSEODeps\Symfony\Component\Security\Http\EventListener\CheckCredentialsListener;
use BeyondSEODeps\Symfony\Component\Security\Http\EventListener\LoginThrottlingListener;
use BeyondSEODeps\Symfony\Component\Security\Http\EventListener\PasswordMigratingListener;
use BeyondSEODeps\Symfony\Component\Security\Http\EventListener\SessionStrategyListener;
use BeyondSEODeps\Symfony\Component\Security\Http\EventListener\UserCheckerListener;
use BeyondSEODeps\Symfony\Component\Security\Http\EventListener\UserProviderListener;
use BeyondSEODeps\Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener;
