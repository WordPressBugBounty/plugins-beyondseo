...
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\CacheWarmer\ExpressionCacheWarmer;
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\EventListener\FirewallListener;
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\Security\FirewallConfig;
...
use BeyondSEODeps\Symfony\Component\Security\Core\Authentication\AuthenticationTrustResolver;
use BeyondSEODeps\Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage;
use BeyondSEODeps\Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorageInterface;
use BeyondSEODeps\Symfony\Component\Security\Core\Authentication\Token\Storage\UsageTrackingTokenStorage;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\AccessDecisionManager;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\AccessDecisionManagerInterface;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\AuthorizationChecker;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\AuthorizationCheckerInterface;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\ExpressionLanguage;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Voter\RoleVoter;
use BeyondSEODeps\Symfony\Component\Security\Core\Role\RoleHierarchy;
use BeyondSEODeps\Symfony\Component\Security\Core\Role\RoleHierarchyInterface;
use BeyondSEODeps\Symfony\Component\Security\Core\Security;
use BeyondSEODeps\Symfony\Component\Security\Core\User\ChainUserProvider;
use BeyondSEODeps\Symfony\Component\Security\Core\User\InMemoryUserChecker;
use BeyondSEODeps\Symfony\Component\Security\Core\User\InMemoryUserProvider;
use BeyondSEODeps\Symfony\Component\Security\Core\User\MissingUserProvider;
use BeyondSEODeps\Symfony\Component\Security\Core\Validator\Constraints\UserPasswordValidator;
use BeyondSEODeps\Symfony\Component\Security\Http\Authentication\AuthenticationUtils;
use BeyondSEODeps\Symfony\Component\Security\Http\Controller\UserValueResolver;
...
use BeyondSEODeps\Symfony\Component\Security\Http\Impersonate\ImpersonateUrlGenerator;
use BeyondSEODeps\Symfony\Component\Security\Http\Logout\LogoutUrlGenerator;
use BeyondSEODeps\Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy;
use BeyondSEODeps\Symfony\Component\Security\Http\Session\SessionAuthenticationStrategyInterface;
