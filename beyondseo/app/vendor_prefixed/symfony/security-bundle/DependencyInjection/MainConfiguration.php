...
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\DependencyInjection\Security\Factory\AbstractFactory;
                    ...
                    ->then(function ($requiredBadges) {
                        return array_map(function ($requiredBadge) {
                            ...
                            if (false === strpos($requiredBadge, '\\')) {
                                $fqcn = 'BeyondSEODeps\Symfony\Component\Security\Http\Authenticator\Passport\Badge\\'.$requiredBadge;
