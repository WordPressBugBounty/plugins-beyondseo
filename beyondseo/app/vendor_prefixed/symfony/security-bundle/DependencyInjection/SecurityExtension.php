...
namespace BeyondSEODeps\Symfony\Bundle\SecurityBundle\DependencyInjection;

use Symfony\Bridge\Twig\Extension\LogoutUrlExtension;
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\DependencyInjection\Security\Factory\AuthenticatorFactoryInterface;
use BeyondSEODeps\Symfony\Bundle\SecurityBundle\DependencyInjection\Security\Factory\FirewallListenerFactoryInterface;
...
use BeyondSEODeps\Symfony\Component\Config\Definition\Exception\InvalidConfigurationException;
...
use BeyondSEODeps\Symfony\Component\DependencyInjection\Extension\PrependExtensionInterface;
...
use BeyondSEODeps\Symfony\Component\PasswordHasher\Hasher\NativePasswordHasher;
use BeyondSEODeps\Symfony\Component\PasswordHasher\Hasher\Pbkdf2PasswordHasher;
use BeyondSEODeps\Symfony\Component\PasswordHasher\Hasher\PlaintextPasswordHasher;
use BeyondSEODeps\Symfony\Component\PasswordHasher\Hasher\SodiumPasswordHasher;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Strategy\AffirmativeStrategy;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Strategy\ConsensusStrategy;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Strategy\PriorityStrategy;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Strategy\UnanimousStrategy;
use BeyondSEODeps\Symfony\Component\Security\Core\Authorization\Voter\VoterInterface;
...
class SecurityExtension extends Extension implements PrependExtensionInterface
{
    ...
    private function createFirewalls(array $config, ContainerBuilder $container)
    {
        ...
        if (!$customUserChecker) {
            $container->setAlias('BeyondSEODeps\Symfony\Component\Security\Core\User\UserCheckerInterface', new Alias('security.user_checker', false));
        }
    }
    ...
    private function createExpression(ContainerBuilder $container, string $expression): Reference
    {
        ...
        $container
            ->register($id, 'BeyondSEODeps\Symfony\Component\ExpressionLanguage\Expression')
            ->setPublic(false)
    ...
    private function createRequestMatcher(ContainerBuilder $container, ?string $path = null, ?string $host = null, ?int $port = null, array $methods = [], ?array $ips = null, array $attributes = []): Reference
    {
        ...
        $container
            ->register($id, 'BeyondSEODeps\Symfony\Component\HttpFoundation\RequestMatcher')
            ->setPublic(false)
