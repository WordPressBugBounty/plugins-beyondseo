...
use BeyondSEODeps\Symfony\Component\ExpressionLanguage\Expression as ExpressionObject;
...
class Expression extends Constraint
{
    ...
    public function __construct(
        string|ExpressionObject|array|null $expression, ?string $message = null, ?array $values = null, ?array $groups = null, mixed $payload = null,
        array $options = []
    ) {
