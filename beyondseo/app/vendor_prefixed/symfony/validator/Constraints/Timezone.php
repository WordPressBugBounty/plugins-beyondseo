...
class Timezone extends Constraint
{
    ...
    public function __construct( int|array|null $zone = null, ?string $message = null, ?string $countryCode = null, ?bool $intlCompatible = null, ?array $groups = null, mixed $payload = null,
        array $options = []
    ) {
        if (\is_array($zone)) {
