...
use BeyondSEODeps\Symfony\Component\Validator\Exception\GroupDefinitionException;
...
class ClassMetadata extends GenericMetadata implements ClassMetadataInterface
{
    ...
    public function setGroupSequenceProvider(bool $active)
    {
        ...
        if (!$this->getReflectionClass()->implementsInterface('BeyondSEODeps\Symfony\Component\Validator\GroupSequenceProviderInterface')) {
