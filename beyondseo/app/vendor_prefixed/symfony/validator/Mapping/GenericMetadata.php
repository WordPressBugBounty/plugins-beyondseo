...
namespace BeyondSEODeps\Symfony\Component\Validator\Mapping;

use BeyondSEODeps\Symfony\Component\Validator\Constraint;
use BeyondSEODeps\Symfony\Component\Validator\Constraints\Cascade;
use BeyondSEODeps\Symfony\Component\Validator\Constraints\DisableAutoMapping;
use BeyondSEODeps\Symfony\Component\Validator\Constraints\EnableAutoMapping;
use BeyondSEODeps\Symfony\Component\Validator\Constraints\Traverse;
...
class GenericMetadata implements MetadataInterface
{
    ...
    public function addConstraint(Constraint $constraint): static
    {
        if ($constraint instanceof Traverse || $constraint instanceof Cascade) {
            throw new ConstraintDefinitionException(sprintf('The constraint "%s" can only be put on classes. Please use "BeyondSEODeps\Symfony\Component\Validator\Constraints\Valid" instead.', get_debug_type($constraint)));
        }
