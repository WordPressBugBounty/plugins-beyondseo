...
use BeyondSEODeps\Symfony\Component\Validator\Constraints\Composite;
use BeyondSEODeps\Symfony\Component\Validator\Constraints\Existence;
...
use BeyondSEODeps\Symfony\Component\Validator\Context\ExecutionContext;
...
use BeyondSEODeps\Symfony\Component\Validator\Exception\NoSuchMetadataException;
use BeyondSEODeps\Symfony\Component\Validator\Exception\RuntimeException;
use BeyondSEODeps\Symfony\Component\Validator\Exception\UnexpectedValueException;
use BeyondSEODeps\Symfony\Component\Validator\Exception\UnsupportedMetadataException;
use BeyondSEODeps\Symfony\Component\Validator\Exception\ValidatorException;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\CascadingStrategy;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\ClassMetadataInterface;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\Factory\MetadataFactoryInterface;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\GenericMetadata;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\GetterMetadata;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\MetadataInterface;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\PropertyMetadataInterface;
use BeyondSEODeps\Symfony\Component\Validator\Mapping\TraversalStrategy;
use BeyondSEODeps\Symfony\Component\Validator\ObjectInitializerInterface;
use BeyondSEODeps\Symfony\Component\Validator\Util\PropertyPath;
...
class RecursiveContextualValidator implements ContextualValidatorInterface
{
    ...
    public function validateProperty(object $object, string $propertyName, string|GroupSequence|array|null $groups = null): static
    {
        ...
        if (!$classMetadata instanceof ClassMetadataInterface) {
            throw new ValidatorException(sprintf('The metadata factory should return instances of "\BeyondSEODeps\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
        }
    ...
    private function validateObject(object $object, string $propertyPath, array $groups, int $traversalStrategy, ExecutionContextInterface $context)
    {
        try {
            ...
            if (!$classMetadata instanceof ClassMetadataInterface) {
                throw new UnsupportedMetadataException(sprintf('The metadata factory should return instances of "BeyondSEODeps\Symfony\Component\Validator\Mapping\ClassMetadataInterface", got: "%s".', get_debug_type($classMetadata)));
            }
        ...
        foreach ($groups as $key => $group) {
            ...
            if (Constraint::DEFAULT_GROUP === $group) {
                if ($metadata->hasGroupSequence()) {
                    ...
                    // object
                    /* @var \BeyondSEODeps\Symfony\Component\Validator\GroupSequenceProviderInterface $object */
        ...
        foreach ($metadata->getConstrainedProperties() as $propertyName) {
            ...
            foreach ($metadata->getPropertyMetadata($propertyName) as $propertyMetadata) {
                if (!$propertyMetadata instanceof PropertyMetadataInterface) {
                    throw new UnsupportedMetadataException(sprintf('The property metadata instances should implement "BeyondSEODeps\Symfony\Component\Validator\Mapping\PropertyMetadataInterface", got: "%s".', get_debug_type($propertyMetadata)));
                }
