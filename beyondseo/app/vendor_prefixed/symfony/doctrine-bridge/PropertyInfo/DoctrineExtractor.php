 ...
 */
namespace BeyondSEODeps\Symfony\Bridge\Doctrine\PropertyInfo;
...
use BeyondSEODeps\Doctrine\ORM\Mapping\Embedded;
...
class DoctrineExtractor implements PropertyListExtractorInterface, PropertyTypeExtractorInterface, PropertyAccessExtractorInterface
{
    ...
    public function getTypes(string $class, string $property, array $context = []): ?array
    {
        ...
        if ($metadata->hasAssociation($property)) {
            ...
            return [new Type(Type::BUILTIN_TYPE_OBJECT, false, Collection::class, true, new Type($collectionKeyType), new Type(Type::BUILTIN_TYPE_OBJECT, false, $class))];
        }
    ...
    {
        if (null === ($metadata = $this->getMetadata($class)) || ClassMetadata::GENERATOR_TYPE_NONE === $metadata->generatorType || !\in_array($property, $metadata->getIdentifierFieldNames(), true)) {
            return null;
        }
        return false;
    }
