...
namespace BeyondSEODeps\Symfony\Bridge\Doctrine\Security\User;
    ...
    public function loadUserByIdentifier(string $identifier): UserInterface
    {
        ...
        if (null !== $this->property) {
            ...
            if (!$repository instanceof UserLoaderInterface) {
                throw new \InvalidArgumentException(sprintf('You must either make the "%s" entity Doctrine Repository ("%s") implement "BeyondSEODeps\Symfony\Bridge\Doctrine\Security\User\UserLoaderInterface" or set the "property" option in the corresponding entity provider configuration.', $this->classOrAlias, get_debug_type($repository)));
            }
