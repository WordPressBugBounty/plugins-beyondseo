...
use BeyondSEODeps\Doctrine\ORM\Mapping\MappingException as LegacyMappingException;
...
class DoctrineOrmTypeGuesser implements FormTypeGuesserInterface
{
    ...
    public function guessType(string $class, string $property): ?TypeGuess
    {
        ...
        if ($metadata->hasAssociation($property)) {
            ...
            return new TypeGuess('BeyondSEODeps\Symfony\Bridge\Doctrine\Form\Type\EntityType', ['em' => $name, 'class' => $mapping['targetEntity'], 'multiple' => $multiple], Guess::HIGH_CONFIDENCE);
        }
