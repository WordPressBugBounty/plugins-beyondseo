...
namespace BeyondSEODeps\Symfony\Bridge\ProxyManager\LazyProxy\PhpDumper;

use BeyondSEODeps\Laminas\Code\Generator\ClassGenerator;
use BeyondSEODeps\ProxyManager\GeneratorStrategy\BaseGeneratorStrategy;
    ...
    public function getProxyFactoryCode(Definition $definition, string $id, string $factoryCode): string
    {
        ...
        if (\$lazyLoad) {
            $instantiation \$this->createProxy('$proxyClass', function () {
                return \\$proxyClass::staticProxyConstructor(function (&\$wrappedInstance, \BeyondSEODeps\ProxyManager\Proxy\LazyLoadingInterface \$proxy) {
