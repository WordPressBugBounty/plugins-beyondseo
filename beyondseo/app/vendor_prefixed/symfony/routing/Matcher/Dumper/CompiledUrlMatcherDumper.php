...
namespace BeyondSEODeps\Symfony\Component\Routing\Matcher\Dumper;
...
EOF;
    ...
    public static function export(mixed $value): string
    {
        ...
        if (!\is_array($value)) {
            if (\is_object($value)) {
                throw new \InvalidArgumentException('BeyondSEODeps\Symfony\Component\Routing\Route cannot contain objects.');
            }
