...
use BeyondSEODeps\Symfony\Component\Cache\Exception\InvalidArgumentException;
...
class DoctrineDbalAdapter extends AbstractAdapter implements PruneableInterface
{
    ...
    private function getPlatformName(): string
    {
        ...
        switch (true) {
            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\MySQLPlatform:
            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\MySQL57Platform:
                return $this->platformName = 'mysql';

            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\SqlitePlatform:
                return $this->platformName = 'sqlite';

            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\PostgreSQLPlatform:
            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\PostgreSQL94Platform:
                return $this->platformName = 'pgsql';

            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\OraclePlatform:
                return $this->platformName = 'oci';

            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\SQLServerPlatform:
            case $platform instanceof \BeyondSEODeps\Doctrine\DBAL\Platforms\SQLServer2012Platform:
