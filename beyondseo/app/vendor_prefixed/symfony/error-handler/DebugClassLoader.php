...
namespace BeyondSEODeps\Symfony\Component\ErrorHandler;
...
use BeyondSEODeps\Doctrine\Common\Persistence\Proxy as LegacyProxy;
...
use BeyondSEODeps\ProxyManager\Proxy\ProxyInterface;
use ReflectionException;
use ReflectionMethod;
use BeyondSEODeps\Symfony\Component\ErrorHandler\Internal\TentativeTypes;
use BeyondSEODeps\Symfony\Component\VarExporter\LazyObjectInterface;
...
class DebugClassLoader
{
    ...
    public static function enable(): void
    {
        ...
        class_exists(\BeyondSEODeps\Symfony\Component\ErrorHandler\ErrorHandler::class);
        ...
        foreach ($functions as $function) {
            if (is_array($function) && isset($function[0]) &&
                !$function[0] instanceof \BeyondSEODeps\Composer\Autoload\ClassLoader &&
