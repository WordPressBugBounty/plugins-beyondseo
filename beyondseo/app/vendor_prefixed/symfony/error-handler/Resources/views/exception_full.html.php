...
echo $this->include('assets/images/favicon.png');
?>">
        <style><?php 
...
?></style>
    ...
    <body>
        ...
        <?php 
if (class_exists(\BeyondSEODeps\Symfony\Component\HttpKernel\Kernel::class)) {
    ?>
            <header>
                <div class="container">
                    <h1 class="logo"><?php 
    ...
    echo \BeyondSEODeps\Symfony\Component\HttpKernel\Kernel::VERSION;
    ?>/index.html">
                            <span class="icon"><?php 
