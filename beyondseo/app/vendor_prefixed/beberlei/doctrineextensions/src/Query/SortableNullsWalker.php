...
namespace BeyondSEODeps\DoctrineExtensions\Query;
 ...
 *
 * $query = $qb->getQuery();
 * $query->setHint(BeyondSEODeps\Doctrine\ORM\Query::HINT_CUSTOM_OUTPUT_WALKER, 'Webges\DoctrineExtensions\Query\SortableNullsWalker');
