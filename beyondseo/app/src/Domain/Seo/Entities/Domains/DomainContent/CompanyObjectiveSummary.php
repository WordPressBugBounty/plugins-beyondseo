...
namespace BeyondSEO\Domain\Seo\Entities\Domains\DomainContent;

if ( ! defined( 'ABSPATH' ) ) exit; // Exit if accessed directly

use BeyondSEO\Domain\Seo\Entities\Domains\DomainContent;
use BeyondSEO\Domain\Seo\Repo\Argus\Domains\DomainContent\ArgusCompanyObjectiveSummary;
