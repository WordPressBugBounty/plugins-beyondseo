...
return [
    'models' => [
        'db' => [
            'baseDirectory' => BEYONDSEO_APP_ROOT_DIR . '/src/Domain/Common/Repo/DB/Models/',
            'modelNameSpace' => 'BeyondSEO\\Domain\\Common\\Repo\\DB\\Models',
            'dbTablePrefix' => 'Entity',
            'modelNamePrefix' => 'DB'
        ],
        'legacyDB' => [
            'baseDirectory' => BEYONDSEO_APP_ROOT_DIR . '/src/Domain/Common/Repo/LegacyDB/Models/',
            'modelNameSpace' => 'BeyondSEO\\Domain\\Common\\Repo\\LegacyDB\\Models',
